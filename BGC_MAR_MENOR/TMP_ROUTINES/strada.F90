...
!      if(i1d==1.and.i1dbio==0)call advection_bio                       !14-07-14
!      call biobalance_gateC                                            !23-11-13
!      call s_cpu('advection+gateC',0)
...
!      call my_outputs_zone2bioflux('init',0)
!      call my_outputs_zone3bioflux('init',0)
!      call my_outputs_zone4bioflux('init',0)
