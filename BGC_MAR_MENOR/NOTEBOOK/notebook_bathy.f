...
! texte250='../../../MAR_MENOR/BATHYMASK/bathycote_in.ijh'           ! land sea "mapped" mask and bathymetry "i,j,h" format
! texte250='../../../MAR_MENOR/BATHYMASK/bathycote_in_step1.ijh'           ! land sea "mapped" mask and bathymetry "i,j,h" format
...
! texte250='../../../MAR_MENOR/BATHYMASK/bathycote_in_V6.ijh'              ! land sea "mapped" mask and bathymetry "i,j,h" format
  texte250='../../../BGC_MAR_MENOR/BATHYMASK/bathycote_in_20231206.ijh'              ! land sea "mapped" mask and bathymetry "i,j,h" format
...
! Bounds and Smoothing if option=1
 ...
 h_inf=0.3 !           ! h>h_inf(meters) (if ioption==1)
 ...
 nsmooth=1 !10         ! loop number in the smoothing "regular" routine
...
! mergebathy_filename='../../../BGC_MAR_MENOR/samplemercator/ext-PSY4V1R3_mesh_zgr.nc'
...
! https://docs.google.com/document/d/16A8Pb0JjOLYM1cI3CUiwJgDqkAfJhJbr7fkasAPnBoc/edit
  texte250='none' 
! texte250='../../../BGC_MAR_MENOR/BATHYMASK/post_smoothed_bathy_corrector.ijDeltaH'      ! i  ,j   (global indexes) , delta H(meters), distance (indexes)
! texte250='../../../BGC_MAR_MENOR/BATHYMASK/post_smoothed_bathy_corrector.lonlatDeltaH'  ! lon,lat (decimal degrees), delta H(meters), distance (meters)
/
