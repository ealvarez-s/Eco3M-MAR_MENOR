...
kmax=60   ! 50                    ! dimension along the Ok vertical axis
...
! lonlatfile='/tmpdir/cestour/GLOBMED2/OFFLINE_SOL_ET_TIDE16/grid.nc' ! format netcdf
! lonlatfile='/tmpdir/cestour/GLOBMED2/OFFLINE_SOL_ET_TIDE30_occ/grid.nc'
! lonlatfile='/tmpdir/DONNEES_P1331_P09115/OFFLINE_SOL_ET_TIDE30_occ/grid.nc'
!lonlatfile='/tmpdir/DONNEES_P1331_P09115/OFFLINE_SOL_ET_TIDE40_occ/grid.nc'
!lonlatfile='/tmpdir/cestour/GLOBMED2/OFFLINE_SOL_ET_TIDE61/grid.nc'
!lonlatfile='/tmpdir/jhabib/simulations/GLOBMED2/NOTEBOOK_DIC/grid_tide40_occ.nc'
lonlatfile='/tmpdir/DONNEES_P1331_P09115/OFFLINE_SOL_ET_TIDE48/grid.nc'
!  lonlatfile='../../../GLOBMED/BATHYMASK/lonlat_GLOBMED_curvigibraltar_1120_865_4col.txt'

!*** MPI SECTION *******
!nbdom_imax=10 !                       ! number of subdomains along the Oi axis
!nbdom_jmax=10 !                         ! number of subdomains along the Oj axis
nbdom_imax=34 !                        ! number of subdomains along the Oi axis
nbdom_jmax=30 !                         ! number of subdomains along the Oj axis
...
mpi_map_file_name='description_domaine.next'
...
!mpi_hole_plugging='../../../GLOBMED/BATHYMASK/description_trous_34_30.txt'
 mpi_hole_plugging='description_trous.txt'
