...
directory_offline='../../../BGC_MAR_MENOR/OFFLINE_LR/LR_MM_T37_2016-2022_runoffCTE_ssh-mean/'      
   offlinefile(1)='../../../BGC_MAR_MENOR/OFFLINE_LR/LR_MM_T37_2016-2022_runoffCTE_ssh-mean/liste_offline_complete2.txt'
   offlinefile(2)='none'
   offlinefile(3)='none'
   offlinefile(4)='none'
   offlinefile(5)='none'
