...
iglb=25!!100                  ! dimension along the Oi axis (global grid)
jglb=43!!50                   ! dimension along the Oj axis (global grid)
kmax=10!!10!!30                   ! dimension along the Ok vertical axis
dxb=620!!500.                  ! Along Oi axis cellboxe size (m)
dyb=620!!500.                  ! Along Oj axis cellboxe size (m)
phi0=37.84!!45.                  ! Reference latitude for the Mercator projection
longi0=-0.86!!0.                 ! longitude of grid point (I0,J0) relative to north pole
latit0=37.84!!45.                ! latitude of grid point (I0,J0) relative to north pole
grid_i0=1                 ! i0=i(longi0,latit0)
grid_j0=43!!1                 ! j0=j(longi0,latit0)
rayonterre=6370949.!! 6371009. ! 6370949.       ! Earth radius (m)
...
! OFFLINE MODE: use lonlatfile='../../../LR_MM/OFFLINE/grid.nc'e
!! lonlatfile='../../../LR_MM/OFFLINE/grid.nc' ! OFFLINE MODE

! lonlatfile='../../../LR_MM/BATHYMASK/lonlat_4col.txt'   ! format ascii i,j,lon,lat
! lonlatfile='../../../BGC_MAR_MENOR/BATHYMASK/bathycote_in.nc'
 lonlatfile='../../../BGC_MAR_MENOR/OFFLINE_LR/LR_MM_T35_1m/grid.nc' ! OFFLINE MODE
...
nbdom_jmax=8                       ! number of subdomains along the Oj axis
...
! distributions requires an input file whose name (other than 'default') is given in the next line:
 ...
 mpi_map_file_name='../../../BGC_MAR_MENOR/BATHYMASK/description_domaine_LR_48_37.next'
...
! (other than 'none') is given in the next line:
 ...
 mpi_hole_plugging='../../../BGC_MAR_MENOR/BATHYMASK/description_trous_LR_48_37.txt'
...
!initialgridfile_txt='../../../LR_MM/OFFLINE/mesh_mask.ps.nouv.nc'
