...
datesim(1:6,1)= 2013 , 12 , 22 , 12  , 00  , 00  ! Start time (yyyy mm dd hh mm ss)
...
restartfileperiod=1!!100.             ! Production periodicity (see restartfileunits) of the restart files (no file if <=0.)
