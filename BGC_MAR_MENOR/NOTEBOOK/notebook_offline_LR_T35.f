...
directory_offline='../../../BGC_MAR_MENOR/OFFLINE_LR/LR_MM_T35_2y/'      
   offlinefile(1)='../../../BGC_MAR_MENOR/OFFLINE_LR/LR_MM_T35_2y/liste_offline_complete.txt'
   offlinefile(2)='none'
   offlinefile(3)='none'
   offlinefile(4)='none'
   offlinefile(5)='none'
