...
!*** MPI SECTION *******
nbdom_imax=13                       ! number of subdomains along the Oi axis
nbdom_jmax=18                       ! number of subdomains along the Oj axis
...
! mpi_map_file_name='default'        
  mpi_map_file_name='../../../BGC_MAR_MENOR/BATHYMASK/description_domaine.next'
...
! mpi_hole_plugging='none'
  mpi_hole_plugging='../../../BGC_MAR_MENOR/BATHYMASK/description_trous.txt'
