...
ioffline=2 !0   ! 0=not used    | 1=create files | 2=read files | 3= binary to netcdf conversion
...
directory_offline='../../../BGC_MAR_MENOR/OFFLINE_LR/LR_MM_T37_2016-2022_ssh-mean/'      
   offlinefile(1)='../../../BGC_MAR_MENOR/OFFLINE_LR/LR_MM_T37_2016-2022_ssh-mean/liste_offline_complete2.txt'
   offlinefile(2)='none'
   offlinefile(3)='none'
   offlinefile(4)='none'
   offlinefile(5)='none'
...
! Additional variables: (yes=1, no=0)
  ...
  ofl_rhp=0 !!1 !!0           ! potential density
  ofl_tke=0           ! time-averaged turbulent kinetic energy
  ofl_surflux=0       ! time-averaged surface fluxes
...
3.                          2013   12   31   14   29   56 ! repetidos de T35 2016-2017
21.                         2014   01   01   11   29   56       
3.                          2015   12   31   14   29   56 ! repetidos de T35 2016-2017
21.                         2016   01   01   11   29   56
3.                          2016   01   01   14   29   56      
7.5                         2016   01   01   21   59   45 ! inicial T37 ssh-mean
24.                         2022   13   23   21   59   45 ! final T37 ssh-mean
