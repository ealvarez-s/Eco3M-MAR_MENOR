...
! Enter the time for the start and the end of the simulation:
 datesim(1:6,1)= 2011 , 05 , 16 , 00  , 00  , 00  ! Start time (yyyy mm dd hh mm ss)
!datesim(1:6,1)= 2018 , 01 , 03 , 00  , 00  , 00  ! Start time (yyyy mm dd hh mm ss)
!datesim(1:6,2)= 2016 , 01 , 01 , 00  , 00  , 00  ! Start time (yyyy mm dd hh mm ss)
datesim(1:6,2)= 2012 , 03 , 20 , 00  , 00  , 00  ! Start time (yyyy mm dd hh mm ss)

! Define datesim(1:6,2) from a maximum number of iterations of the internal mode:
!iteration3d_max=3 ! active if > 0 . Number of iterations from datesim(1:6,1)
...
flag_binary=0           ! 0= netcdf restart files. 1= old chanel9 restart files
...
! Option 1: give the ratio dt_internal/dt_external
   iteration2d_max_now=26 ! 30  ! ratio dt_internal/dt_external   
