...
! Enter the time for the start and the end of the simulation:
  datesim(1:6,1)= 2012 , 02 , 11 , 00  , 05  , 05 ! Start time (yyyy mm dd hh mm ss)
...
! datesim(1:6,1)= 2018 , 12 , 26 , 00  , 21  , 44 ! Start time (yyyy mm dd hh mmss) simu off50
! datesim(1:6,1)= 2019 , 01 , 05 , 00  , 00  , 00 ! Start time (yyyy mm dd hh mmss) simu off50 fumseck 15/3/23
!  datesim(1:6,1)= 2019 , 05 , 05 , 00  , 13  , 19 ! 
! datesim(1:6,1)= 2021 , 5 , 3 , 00  , 00  , 00 !
...
! datesim(1:6,2)= 2020 , 3 , 10 , 00  , 00  , 00  ! Start time (yyyy mm dd hh mm ss) pour avoir un restart_output pour les donnees de Laurent
  datesim(1:6,2)= 2022 , 12 , 27 , 00  , 00  , 00  ! Start time (yyyy mm dd hh mm ss)
!  datesim(1:6,2)= 2019 , 01 , 05 , 00  , 00  , 00  ! Start time (yyyy mm dd hh mm ss)
!  datesim(1:6,2)= 2019 , 05 , 30 , 00  , 00  , 00  ! Start time (yyyy mm dd hh mm ss) fumseck 15/3/23
