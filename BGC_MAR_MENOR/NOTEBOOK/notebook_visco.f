...
!texte250='../../../MAR_MENOR/BATHYMASK/symphonie-symtools-comodo.nc' ! lon-lat-dependent from file
...
!texte90='../../../MAR_MENOR/BATHYMASK/z0b.ijvaldist'
...
! external/internal modes coupling (vel_u(:,:,:,2)  vel_v(:,:,:,2) only):
  inv_ekman_depth=2. ! 0.1 ! inverse of the Ekman bottom layer thickness in m**-1 
