...
!***  MPI SECTION *******
nbdom_imax=5                       ! number of subdomains along the Oi axis
...
! distributions requires an input file whose name (other than 'default') is given in the next line:
 ...
 mpi_map_file_name='../../../BGC_MAR_MENOR/BATHYMASK/description_domaine_LR_30_23.next'
...
! (other than 'none') is given in the next line:
 ...
 mpi_hole_plugging='../../../BGC_MAR_MENOR/BATHYMASK/description_trous_LR_30_23.txt'
