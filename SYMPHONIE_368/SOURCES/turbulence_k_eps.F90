...
!...............................................................................
      ...
      implicit none
#ifdef synopsis
       subroutinetitle='turbulence_k_eps_allocate_init'
       subroutinedescription= &
       'k-eps arrays allocation'
...
#ifdef synopsis
       subroutinetitle='turbulence_k_eps'
       subroutinedescription= &
       'Computes K and EPS of the K-EPS turbulent scheme'
       call main_synopsis(subroutinetitle,subroutinedescription)
#endif

#ifdef bidon
        if(flag_merged_levels==1) then !m°v°m> !06-12-19
! Eviter la singularite de proximite de la frontiere solide liee A depth_w(kmerged) potentiellement collee A depth_w(kmin)
! en placant depth_w(kmerged) A 0.5*dz(kmerged) au dessus du fond
! Etape 1: faire l'ajustement (voir aussi plus loin etape 2)
         do j=1,jmax ; do i=1,imax
! methode 1
!         depth_w(i,j,kmin_w(i,j)+1)=depth_w(i,j,kmin_w(i,j))+0.5*dz_t(i,j,kmerged_t(i,j),2)
! methode 2
          depth_w(i,j,kmin_w(i,j)+1)=0.5*(depth_t(i,j,kmin_w(i,j)+1)+depth_t(i,j,kmin_w(i,j)))
         enddo       ; enddo
...
! Cas particulkier de la couche kmerged !06-12-19
        do j=2,jmax-1 ; do i=2,imax-1
          tkea_w(i,j,kmerged_t(i,j))=0.5*(tkea_w(i,j,kmin_w(i,j))+tkea_w(i,j,kmerged_t(i,j)+1))
        enddo       ; enddo
      endif                          !m°v°m>
#endif
...
! Cas particulkier de la couche kmerged !06-12-19
        do j=2,jmax-1 ; do i=2,imax-1
          epsa_w(i,j,kmerged_t(i,j))=0.5*(epsa_w(i,j,kmin_w(i,j))+epsa_w(i,j,kmerged_t(i,j)+1))
!         epsa_w(i,j,kmerged_t(i,j))=epsa_w(i,j,kmerged_t(i,j)+1)
!         epsa_w(i,j,kmerged_t(i,j))=epsa_w(i,j,kmin_w(i,j))
        enddo       ; enddo
      endif                          !m°v°m>
#endif
...
! Eviter la singularite de proximite de la frontiere solide liee A depth_w(kmerged) potentiellement collee A depth_w(kmin)
! en placant depth_w(kmerged) A 0.5*dz(kmerged) au dessus du fond
! Etape 2: retablir zw(kmin+1)
         do j=1,jmax ; do i=1,imax
          depth_w(i,j,kmin_w(i,j)+1)=2*depth_t(i,j,kmin_w(i,j))-depth_w(i,j,kmin_w(i,j))
         enddo       ; enddo
        endif                          !m°v°m> !06-12-19
#endif
...
!#endif
        ...
        do i=2,imax-1
           ...
           tridia_in(i,j,kmax,4)+x1*wstress_w(i,j)**1.5
        enddo
        enddo
#endif
...
!...............................................................................
      ...
      implicit none
#ifdef synopsis
       subroutinetitle='turbulence_k_eps_kz'
       subroutinedescription=''
       call main_synopsis(subroutinetitle,subroutinedescription)
#endif
...
!...............................................................................
      ...
      real*4,parameter ::                                              &
               ...
               ,s6_=0.3964
#ifdef synopsis
       subroutinetitle='turbulence_k_eps_ca01'
       subroutinedescription= &
...
!...............................................................................
      ...
      implicit none
#ifdef synopsis
       subroutinetitle='turbulence_k_eps_gp88'
       subroutinedescription= &
...
!...............................................................................
      ...
      implicit none
#ifdef synopsis
       subroutinetitle='turbulence_k_eps_kc94'
       subroutinedescription= &
       'km and kh using stability fonction from KC94'
       call main_synopsis(subroutinetitle,subroutinedescription)
#endif
      real*4,parameter ::      &
               kc1_=0.4939277  &
...
!.....................................................................
      ...
      character*3 txt_
#ifdef synopsis
       subroutinetitle='turbulence_k_eps_bc_e87'
       subroutinedescription= &
       'Computes tridia_in(4) for the surface/bottom border condition' &
      ,' following Estournel et al 1987'
       call main_synopsis(subroutinetitle,subroutinedescription)
#endif
...
#ifdef stokes
! note 0.4*1.6=0.64
      z0s=1.6*hsw_wave_t(i,j,1) ! these Nicolas Rascle page 43 & Eq 2.12  !06-05-11 !02-03-16
#endif
...
!.....................................................................
      ...
      character*3 txt_
#ifdef synopsis
       subroutinetitle='turbulence_k_eps_bc_neutral'
       subroutinedescription= &
       'Computes tridia_in(4) a surface/bottom border condition' &
      ,' for epsilon supposing neutral stratification'
       call main_synopsis(subroutinetitle,subroutinedescription)
#endif
...
!.....................................................................
      ...
      character*3 txt_
#ifdef synopsis
       subroutinetitle='turbulence_k_eps_bc_tkebuo'
       subroutinedescription= &
       'Computes tridia_in(4) a surface/bottom border condition' &
      ,' for epsilon using the length scale formula of Reffray '
      ,' et al 2015'
       call main_synopsis(subroutinetitle,subroutinedescription)
#endif
