...
! Pour la simulation de Sete NH (commente le 03-12-19)
!      sqr_goverh_v(i,2)=sqrt(grav/max(h_w(i,jmax),wetdry_cst2)) !01-02-19
!      sqr_goverh_v(i,1)=sqrt(grav/max(h_w(i,1   ),wetdry_cst2)) !01-02-19
...
! Pour la simulation de Sete NH
!      sqr_goverh_u(j,2)=sqrt(grav/max(h_w(imax,j),wetdry_cst2)) !17-03-19
!      sqr_goverh_u(j,1)=sqrt(grav/max(h_w(1   ,j),wetdry_cst2)) !17-03-19
