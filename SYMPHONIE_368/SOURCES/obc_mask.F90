...
!______________________________________________________________________
      ...
      integer case_
#ifdef synopsis
       subroutinetitle='obc_mask'
       subroutinedescription= &
       'Open lateral boundary on the Sea-Land mask'
...
#ifdef synopsis
       subroutinetitle='obc_mask_mpi'
       subroutinedescription= &
       'Lateral boundary conditions on the Sea-Land mask ensuring mpi' &
       //' continuity'
       call main_synopsis(subroutinetitle,subroutinedescription)
#endif
