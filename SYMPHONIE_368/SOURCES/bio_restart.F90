...
! release 310 last update: 05-11-21
!______________________________________________________________________
...
!                   n'est pas achevee
! v287    18-07-20  utiliser restartdir_out1....
! v310    05-11-21  debug texte60
!...............................................................................
...
!        dynrestartfilename(1:14)= restartdir_out2
         texte60=trim(restartdir_out1)//'chanelbio_'//dom_c !05-11-21
      else                                                !---->
!        dynrestartfilename(1:14)= restartdir_out1
         texte60=trim(restartdir_out2)//'chanelbio_'//dom_c !05-11-21
      endif     
...
! Ne pas ecrire le fichier si solution bugguee:
      ...
      sum2=0. ;  sum3=0.; sum0=small1 ; k0=min(30,vbmax) !20-07-15
      do k=1,kmax
      do j=1,jmax
      do i=1,imax
       sum0=sum0+mask_t(i,j,k)*dz_t(i,j,k,2)*dxdy_t(i,j)
       sum2=sum2+mask_t(i,j,k)*dz_t(i,j,k,2)*dxdy_t(i,j)*bio_t(i,j,k,k0)
...
!     write(texte60,'(a,i0,a)')restartdir_out1//'biocheckrestartfile',par%rank !17-01-15
      write(texte60,'(a,i0)') &
      trim(restartdir_out1)//'biocheckrestartfile',par%rank !05-11-21
