...
! release S26 - last update: 14-11-18
!______________________________________________________________________
      ...
      integer,dimension(:,:),allocatable :: &
       datesimbis
#ifdef synopsis
       subroutinetitle='dyn_restart'
       subroutinedescription='Reads or writes the restart files'
...
! Check dates consistenties using a datesimbis, a copy of datesim
      ...
      write(texte60,'(a,i0)')'restart_input/chanel9_',par%rank !06-05-16
...
! insere partie_lit_1 debut: SURTOUT NE PAS EFFACER CETTE LIGNE
      ...
      if(allocated(dsig_u))call netcdfrestart_read(dsig_u,'dsig_u',lbound(dsig_u),ubound(dsig_u))
      if(allocated(dsig_v))call netcdfrestart_read(dsig_v,'dsig_v',lbound(dsig_v),ubound(dsig_v))
      ...
      if(allocated(zeroleveldepth_u))call netcdfrestart_read(zeroleveldepth_u,'zeroleveldepth_u',lbound(zeroleveldepth_u),ubound(zeroleveldepth_u))
      if(allocated(zeroleveldepth_v))call netcdfrestart_read(zeroleveldepth_v,'zeroleveldepth_v',lbound(zeroleveldepth_v),ubound(zeroleveldepth_v))
      ...
      if(allocated(sqr_goverh_v))call netcdfrestart_read(sqr_goverh_v,'sqr_goverh_v',lbound(sqr_goverh_v),ubound(sqr_goverh_v))
      ...
      if(allocated(dfvofl_w))call netcdfrestart_read(dfvofl_w,'dfvofl_w',lbound(dfvofl_w),ubound(dfvofl_w))
      ...
      if(allocated(w0mofl_w))call netcdfrestart_read(w0mofl_w,'w0mofl_w',lbound(w0mofl_w),ubound(w0mofl_w))
      if(allocated(kslofl_t))call netcdfrestart_read(kslofl_t,'kslofl_t',lbound(kslofl_t),ubound(kslofl_t))
      ...
      if(allocated(grh_out_var))read(9)grh_out_var
...
!     endif                                               !---->
      ...
      k1=0 ; k2=0
      k1=index(dynrestartfilename,'restart_output')
      k2=index(dynrestartfilename,'restart_outbis')
      if(k1/=0)dynrestartfilename(k1:k1+13)='restart_outbis'
      if(k2/=0)dynrestartfilename(k2:k2+13)='restart_output'
...
! insere partie_ecrit_1 debut: SURTOUT NE PAS EFFACER CETTE LIGNE
      ...
      if(allocated(dsig_u))call netcdfrestart_wrt(dsig_u,'dsig_u',lbound(dsig_u),ubound(dsig_u))
      if(allocated(dsig_v))call netcdfrestart_wrt(dsig_v,'dsig_v',lbound(dsig_v),ubound(dsig_v))
      ...
      if(allocated(zeroleveldepth_u))call netcdfrestart_wrt(zeroleveldepth_u,'zeroleveldepth_u',lbound(zeroleveldepth_u),ubound(zeroleveldepth_u))
      if(allocated(zeroleveldepth_v))call netcdfrestart_wrt(zeroleveldepth_v,'zeroleveldepth_v',lbound(zeroleveldepth_v),ubound(zeroleveldepth_v))
      ...
      if(allocated(sqr_goverh_v))call netcdfrestart_wrt(sqr_goverh_v,'sqr_goverh_v',lbound(sqr_goverh_v),ubound(sqr_goverh_v))
      ...
      if(allocated(grh_out_var))write(9)grh_out_var
...
#ifdef synopsis
       subroutinetitle='dyn_restart_ask'
       subroutinedescription= &
       'Checks if the writing conditions of the restart files are ' &
       //'satisfied'
       call main_synopsis(subroutinetitle,subroutinedescription)
#endif
...
!     texte90=txt6_loc//dom_c//'_'//texte30(1:15)
      ...
      dynrestartfilename=trim(restartdirname)//'restart_output/chanel9'//trim(texte90)
...
!         ,file='restart_output/checkrestartfile'//dom_c//'.ascii')
      write(texte60,'(a,i0)') &
      trim(restartdirname)//'restart_output/checkrestartfile',par%rank
...
!.......................................................................
      ...
      k=0   ; k=index(dynrestartfilename,'restart_output')
      if(k==0)k=index(dynrestartfilename,'restart_outbis')
      write(texte60,'(a,i0)') &
      dynrestartfilename(1:k+13)//'/dynrestartbounds',par%rank
...
! jalon1 dyn_restart_check ne pas effacer
      ...
      if(allocated(dsig_u))write(3,*)'dsig_u',1+ubound(dsig_u)-lbound(dsig_u)
      if(allocated(dsig_v))write(3,*)'dsig_v',1+ubound(dsig_v)-lbound(dsig_v)
      ...
      if(allocated(zeroleveldepth_u))write(3,*)'zeroleveldepth_u',1+ubound(zeroleveldepth_u)-lbound(zeroleveldepth_u)
      if(allocated(zeroleveldepth_v))write(3,*)'zeroleveldepth_v',1+ubound(zeroleveldepth_v)-lbound(zeroleveldepth_v)
      ...
      if(allocated(sqr_goverh_v))write(3,*)'sqr_goverh_v',1+ubound(sqr_goverh_v)-lbound(sqr_goverh_v)
...
!.......................................................................
      ...
      implicit none
      write(texte60,'(a,i0)') &
      trim(restartdirname)//'restart_input/dynrestartbounds',par%rank
      open(unit=3,file=trim(texte60))
...
!.......................................................................
      ...
      character*1 txt_
#ifdef synopsis
       subroutinetitle='dyn_restart_allo'
       subroutinedescription= &
       'allocates/deallocates offline arrays if required'
       call main_synopsis(subroutinetitle,subroutinedescription)
#endif
