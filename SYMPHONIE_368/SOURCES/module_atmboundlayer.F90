...
contains
      ...
      implicit none
#ifdef synopsis
       subroutinetitle='atmboundlayer_initial'
       subroutinedescription= &
        ' Starts the atmospheric boundary layer model'
...
!......................................................................
      ...
      integer case_,t_ 
#ifdef synopsis
       subroutinetitle='atmboundlayer_sstmeteo'
       subroutinedescription= &
         'Computes latent and sensible heat fluxes using the bulk' &
       ,' and the SST of the meteorological model'
       call main_synopsis(subroutinetitle,subroutinedescription)
#endif
...
!......................................................................
      ...
      implicit none
#ifdef synopsis
       subroutinetitle='atmboundlayer_windcfl'
       subroutinedescription= &
         'Computes the highest possible time step for the advection'
       ,' of temperature and humidity anomalies by wind'
       call main_synopsis(subroutinetitle,subroutinedescription)
#endif

#ifdef checkmpi
      call atmboundlayer_checkmpi1
#endif
...
#ifdef synopsis
       subroutinetitle='atmboundlayer_balance'
       subroutinedescription= &
         'Computes the anomalies of air temperature and specific' &
       ,' humidity resulting from air/sea fluxes inconsistencies' &
       ,' and their transport by wind'
       call main_synopsis(subroutinetitle,subroutinedescription)
#endif
...
#ifdef checkmpi
      if(flag_1dv==1) then !>>> !26-02-16
       call atmboundlayer_checkmpi_1dv
      else                                             !>>>
       call atmboundlayer_checkmpi2(2)
       call atmboundlayer_checkmpi3(2)
       call atmboundlayer_checkmpi4(2)
      endif                                            !>>>
#endif
...
!......................................................................
      ...
      implicit none
#ifdef synopsis
       subroutinetitle='atmboundlayer_fieldcorrection'
       subroutinedescription= &
         'Add the anomalies of air temperature and specific' &
       ,' humidity to current teta2 and q2 fields'
       call main_synopsis(subroutinetitle,subroutinedescription)
#endif
...
#ifdef synopsis
       subroutinetitle='atmboundlayer_mpi'
       subroutinedescription= &
         'mpi boundary conditions for teta2deltadelta_t and q2delta_t'
#endif
...
!..............................................................................
#ifdef checkmpi
      subroutine atmboundlayer_checkmpi2(case_)
      use module_principal
      use module_parallele                                        !#MPI !16-09-09
      implicit none
      integer loop_,case_
#ifdef synopsis
       subroutinetitle='atmboundlayer_checkmpi2'
       subroutinedescription= &
       'Checks the mpi continuity of the q2delta_t field'
       call main_synopsis(subroutinetitle,subroutinedescription)
#endif
...
!     if(mask_t(i,j1,kmax)==1) then
       if(xy_t(i,j1,1)/=q2delta_t(i,j1,1))then
        ksecu=1
        write(10+par%rank,*)'appel apres action ',case_
        ...
        write(10+par%rank,*) &
         'q2delta',xy_t(i,j1,1),q2delta_t(i,j1,1),xy_t(i,j1,1)-q2delta_t(i,j1,1)
...
!     if(mask_t(i,j2,kmax)==1) then
       if(xy_t(i,j2,1)/=q2delta_t(i,j2,1))then
        ksecu=1
        write(10+par%rank,*)'appel apres action ',case_
        ...
        write(10+par%rank,*) &
         'q2delta',xy_t(i,j2,1),q2delta_t(i,j2,1),xy_t(i,j2,1)-q2delta_t(i,j2,1)
...
!     if(mask_t(i1,j,kmax)==1) then
       if(xy_t(i1,j,1)/=q2delta_t(i1,j,1)) then
        ksecu=1
        write(10+par%rank,*)'appel apres action ',case_
        write(10+par%rank,*)'mpi non conservé en par%rank i j =' &
          ,par%rank,i1,j
        ...
        write(10+par%rank,*) &
          'q2delta',xy_t(i1,j,1),q2delta_t(i1,j,1),xy_t(i1,j,1)-q2delta_t(i1,j,1)
...
!     if(mask_t(i2,j,kmax)==1) then
       if(xy_t(i2,j,1)/=q2delta_t(i2,j,1)) then
        ksecu=1
        write(10+par%rank,*)'appel apres action ',case_
        write(10+par%rank,*)'mpi non conservé en par%rank i j =' &
          ,par%rank,i2,j
        write(10+par%rank,*)'          voisin en par%rank i j =' &
          ,par%tvoisin(est),2,j
        write(10+par%rank,*) &
          'q2delta',xy_t(i2,j,1),q2delta_t(i2,j,1),xy_t(i2,j,1)-q2delta_t(i2,j,1)
...
!     endif
      ...
      write(6,*)'Erreurs mpi notifiees dans fichiers fort locaux'
        stop 'STOP dans atmboundlayer_checkmpi2'
      endif

      end subroutine atmboundlayer_checkmpi2
#endif

!................................................................................................
#ifdef checkmpi
      subroutine atmboundlayer_checkmpi1
      use module_principal
      use module_parallele                                        !#MPI !16-09-09
      implicit none
      integer loop_
#ifdef synopsis
       subroutinetitle='atmboundlayer_checkmpi1'
       subroutinedescription= &
       'Checks the mpi continuity of the ablheight_t field'
       call main_synopsis(subroutinetitle,subroutinedescription)
#endif
...
! Pour verifier la conservation de la parallelisation:
      ...
      do i=1,imax
!     if(mask_t(i,j1,kmax)==1) then
       if(xy_t(i,j1,1)/=ablheight_t(i,j1,2))then
        ksecu=1
        write(10+par%rank,*)'mpi non conservé en par%rank i j =',par%rank,i,j1
        write(10+par%rank,*)'voisin sud',par%tvoisin(sud)
        k0=par%tvoisin(sud) ; j0=par%gtjmax(k0,2)-par%gtjmax(k0,1) ! j0=jmax du voisin
        write(10+par%rank,*)'coordonnées ',i,j0-1   ! jmax-1
        write(10+par%rank,*) &
         'ablheight_t',xy_t(i,j1,1),ablheight_t(i,j1,2),xy_t(i,j1,1)-ablheight_t(i,j1,2)
        write(10+par%rank,*)'mask_t & h_w:',mask_t(i,j1,kmax),h_w(i,j1)
        write(10+par%rank,*)'iteration3d & 2d=',iteration3d,iteration2d!23-04-14
        write(10+par%rank,*)'-----------------------------------------'!23-04-14
       endif
!     endif
      ...
      do i=1,imax
!     if(mask_t(i,j2,kmax)==1) then
       if(xy_t(i,j2,1)/=ablheight_t(i,j2,2))then
        ksecu=1
        write(10+par%rank,*)'mpi non conservé en par%rank i j =' &
         ,par%rank,i,j2
        write(10+par%rank,*)'          voisin en par%rank i j =' &
         ,par%tvoisin(nord),i,2
        write(10+par%rank,*) &
         'ablheight_t',xy_t(i,j2,1),ablheight_t(i,j2,2),xy_t(i,j2,1)-ablheight_t(i,j2,2)
        write(10+par%rank,*)'mask_t & h_w:',mask_t(i,j2,kmax),h_w(i,j2)
        write(10+par%rank,*)'iteration3d & 2d=',iteration3d,iteration2d!23-04-14
        write(10+par%rank,*)'-----------------------------------------'!23-04-14
       endif
!     endif
      ...
      do j=1,jmax
!     if(mask_t(i1,j,kmax)==1) then
       if(xy_t(i1,j,1)/=ablheight_t(i1,j,2)) then
        ksecu=1
        write(10+par%rank,*)'mpi non conservé en par%rank i j =' &
          ,par%rank,i1,j
        write(10+par%rank,*)'voisin ouest=',par%tvoisin(ouest)
        ...
        write(10+par%rank,*)'coordonnées ',i0-1,j ! imax-1,j
        write(10+par%rank,*) &
          'ablheight_t',xy_t(i1,j,1),ablheight_t(i1,j,2),xy_t(i1,j,1)-ablheight_t(i1,j,2)
        write(10+par%rank,*)'mask_t & h_w:',mask_t(i1,j,kmax),h_w(i1,j)
        write(10+par%rank,*)'iteration3d & 2d=',iteration3d,iteration2d!23-04-14
        write(10+par%rank,*)'-----------------------------------------'!23-04-14
       endif
!     endif
      ...
      do j=1,jmax
!     if(mask_t(i2,j,kmax)==1) then
       if(xy_t(i2,j,1)/=ablheight_t(i2,j,2)) then
        ksecu=1
        write(10+par%rank,*)'mpi non conservé en par%rank i j =' &
          ,par%rank,i2,j
        write(10+par%rank,*)'          voisin en par%rank i j =' &
          ,par%tvoisin(est),2,j
        write(10+par%rank,*) &
          'ablheight_t',xy_t(i2,j,1),ablheight_t(i2,j,2),xy_t(i2,j,1)-ablheight_t(i2,j,2)
        write(10+par%rank,*)'mask_t & h_w:',mask_t(i2,j,kmax),h_w(i2,j)
        write(10+par%rank,*)'iteration3d & 2d=',iteration3d,iteration2d!23-04-14
        write(10+par%rank,*)'-----------------------------------------'!23-04-14
       endif
!     endif
      ...
      if(ksecu==1)then
      write(6,*)'Erreurs mpi notifiees dans fichiers fort locaux'
        stop 'STOP dans atmboundlayer_checkmpi1'
      endif

      end subroutine atmboundlayer_checkmpi1
#endif
!................................................................................................
#ifdef checkmpi
      subroutine atmboundlayer_checkmpi3(case_)
      use module_principal
      use module_parallele                                        !#MPI !16-09-09
      implicit none
      integer loop_,case_
#ifdef synopsis
       subroutinetitle='atmboundlayer_checkmpi3'
       subroutinedescription= &
       'Checks the mpi continuity of the uwinddelta_t field'
       call main_synopsis(subroutinetitle,subroutinedescription)
#endif

      if(flag_abl2/=1)return !22-12-15

! Pour verifier la conservation de la parallelisation:
      do j=1,jmax
      do i=1,imax
       xy_t(i,j,1)=uwinddelta_t(i,j,1)
      enddo
      enddo
      call obc_h_xyt1
      ...
      do i=1,imax
!     if(mask_t(i,j1,kmax)==1) then
       if(xy_t(i,j1,1)/=uwinddelta_t(i,j1,1))then
        ksecu=1
        write(10+par%rank,*)'appel apres action ',case_
        write(10+par%rank,*)'mpi non conservé en par%rank i j =',par%rank,i,j1
        write(10+par%rank,*)'voisin sud',par%tvoisin(sud)
        ...
        write(10+par%rank,*)'coordonnées ',i,j0-1   ! jmax-1
        write(10+par%rank,*) &
         'uwinddelta',xy_t(i,j1,1),uwinddelta_t(i,j1,1),xy_t(i,j1,1)-uwinddelta_t(i,j1,1)
        write(10+par%rank,*)'mask_t & h_w:',mask_t(i,j1,kmax),h_w(i,j1)
        write(10+par%rank,*)'iteration3d & 2d=',iteration3d,iteration2d!23-04-14
...
!     endif
      ...
      do i=1,imax
!     if(mask_t(i,j2,kmax)==1) then
       if(xy_t(i,j2,1)/=uwinddelta_t(i,j2,1))then
        ksecu=1
        write(10+par%rank,*)'appel apres action ',case_
        write(10+par%rank,*)'mpi non conservé en par%rank i j =' &
         ,par%rank,i,j2
        write(10+par%rank,*)'     voisin nord en par%rank i j =' &
         ,par%tvoisin(nord),i,2
        write(10+par%rank,*) &
         'uwinddelta',xy_t(i,j2,1),uwinddelta_t(i,j2,1),xy_t(i,j2,1)-uwinddelta_t(i,j2,1)
        write(10+par%rank,*)'mask_t & h_w:',mask_t(i,j2,kmax),h_w(i,j2)
        write(10+par%rank,*)'iteration3d & 2d=',iteration3d,iteration2d!23-04-14
        write(10+par%rank,*)'imax jmax',imax,jmax
        write(10+par%rank,*)'-----------------------------------------'!23-04-14
...
!     endif
      ...
      do j=1,jmax
!     if(mask_t(i1,j,kmax)==1) then
       if(xy_t(i1,j,1)/=uwinddelta_t(i1,j,1)) then
        ksecu=1
        write(10+par%rank,*)'appel apres action ',case_
        write(10+par%rank,*)'mpi non conservé en par%rank i j =' &
          ,par%rank,i1,j
        ...
        write(10+par%rank,*)'coordonnées ',i0-1,j ! imax-1,j
        write(10+par%rank,*) &
          'uwinddelta',xy_t(i1,j,1),uwinddelta_t(i1,j,1),xy_t(i1,j,1)-uwinddelta_t(i1,j,1)
        write(10+par%rank,*)'mask_t & h_w:',mask_t(i1,j,kmax),h_w(i1,j)
        write(10+par%rank,*)'iteration3d & 2d=',iteration3d,iteration2d!23-04-14
        write(10+par%rank,*)'imax jmax',imax,jmax
        write(10+par%rank,*)'-----------------------------------------'!23-04-14
...
!     endif
      ...
      do j=1,jmax
!     if(mask_t(i2,j,kmax)==1) then
       if(xy_t(i2,j,1)/=uwinddelta_t(i2,j,1)) then
        ksecu=1
        write(10+par%rank,*)'appel apres action ',case_
        write(10+par%rank,*)'mpi non conservé en par%rank i j =' &
          ,par%rank,i2,j
        write(10+par%rank,*)'      voisin Est en par%rank i j =' &
          ,par%tvoisin(est),2,j
        write(10+par%rank,*) &
          'uwinddelta',xy_t(i2,j,1),uwinddelta_t(i2,j,1),xy_t(i2,j,1)-uwinddelta_t(i2,j,1)
        write(10+par%rank,*)'mask_t & h_w:',mask_t(i2,j,kmax),h_w(i2,j)
        write(10+par%rank,*)'iteration3d & 2d=',iteration3d,iteration2d!23-04-14
        write(10+par%rank,*)'imax jmax',imax,jmax
        write(10+par%rank,*)'-----------------------------------------'!23-04-14
...
!     endif
      ...
      if(ksecu==1)then
      write(6,*)'Erreurs mpi notifiees dans fichiers fort locaux'
        stop 'STOP dans atmboundlayer_checkmpi3'
      endif

      end subroutine atmboundlayer_checkmpi3
#endif

!................................................................................................
#ifdef checkmpi
      subroutine atmboundlayer_checkmpi4(case_)
      use module_principal
      use module_parallele                                        !#MPI !16-09-09
      implicit none
      integer loop_,case_
       ...
       subroutinetitle='atmboundlayer_checkmpi2'
       subroutinedescription= &
       'Checks the mpi continuity of the vwinddelta_t field'
       call main_synopsis(subroutinetitle,subroutinedescription)
#endif
...
! Pour verifier la conservation de la parallelisation:
      ...
      do i=1,imax
!     if(mask_t(i,j1,kmax)==1) then
       if(xy_t(i,j1,1)/=vwinddelta_t(i,j1,1))then
        ksecu=1
        write(10+par%rank,*)'appel apres action ',case_
        write(10+par%rank,*)'mpi non conservé en par%rank i j =',par%rank,i,j1
        write(10+par%rank,*)'voisin sud',par%tvoisin(sud)
        ...
        write(10+par%rank,*)'coordonnées ',i,j0-1   ! jmax-1
        write(10+par%rank,*) &
         'vwinddelta',xy_t(i,j1,1),vwinddelta_t(i,j1,1),xy_t(i,j1,1)-vwinddelta_t(i,j1,1)
        write(10+par%rank,*)'mask_t & h_w:',mask_t(i,j1,kmax),h_w(i,j1)
        write(10+par%rank,*)'iteration3d & 2d=',iteration3d,iteration2d!23-04-14
        write(10+par%rank,*)'-----------------------------------------'!23-04-14
       endif
!     endif
      ...
      do i=1,imax
!     if(mask_t(i,j2,kmax)==1) then
       if(xy_t(i,j2,1)/=vwinddelta_t(i,j2,1))then
        ksecu=1
        write(10+par%rank,*)'appel apres action ',case_
        write(10+par%rank,*)'mpi non conservé en par%rank i j =' &
         ,par%rank,i,j2
        write(10+par%rank,*)'          voisin en par%rank i j =' &
         ,par%tvoisin(nord),i,2
        write(10+par%rank,*) &
         'vwinddelta',xy_t(i,j2,1),vwinddelta_t(i,j2,1),xy_t(i,j2,1)-vwinddelta_t(i,j2,1)
        write(10+par%rank,*)'mask_t & h_w:',mask_t(i,j2,kmax),h_w(i,j2)
        write(10+par%rank,*)'iteration3d & 2d=',iteration3d,iteration2d!23-04-14
        write(10+par%rank,*)'-----------------------------------------'!23-04-14
       endif
!     endif
      ...
      do j=1,jmax
!     if(mask_t(i1,j,kmax)==1) then
       if(xy_t(i1,j,1)/=vwinddelta_t(i1,j,1)) then
        ksecu=1
        write(10+par%rank,*)'appel apres action ',case_
        write(10+par%rank,*)'mpi non conservé en par%rank i j =' &
          ,par%rank,i1,j
        ...
        write(10+par%rank,*)'coordonnées ',i0-1,j ! imax-1,j
        write(10+par%rank,*) &
          'vwinddelta',xy_t(i1,j,1),vwinddelta_t(i1,j,1),xy_t(i1,j,1)-vwinddelta_t(i1,j,1)
        write(10+par%rank,*)'mask_t & h_w:',mask_t(i1,j,kmax),h_w(i1,j)
        write(10+par%rank,*)'iteration3d & 2d=',iteration3d,iteration2d!23-04-14
        write(10+par%rank,*)'-----------------------------------------'!23-04-14
       endif
!     endif
      ...
      do j=1,jmax
!     if(mask_t(i2,j,kmax)==1) then
       if(xy_t(i2,j,1)/=vwinddelta_t(i2,j,1)) then
        ksecu=1
        write(10+par%rank,*)'appel apres action ',case_
        write(10+par%rank,*)'mpi non conservé en par%rank i j =' &
          ,par%rank,i2,j
        write(10+par%rank,*)'          voisin en par%rank i j =' &
          ,par%tvoisin(est),2,j
        write(10+par%rank,*) &
          'vwinddelta',xy_t(i2,j,1),vwinddelta_t(i2,j,1),xy_t(i2,j,1)-vwinddelta_t(i2,j,1)
        write(10+par%rank,*)'mask_t & h_w:',mask_t(i2,j,kmax),h_w(i2,j)
        write(10+par%rank,*)'iteration3d & 2d=',iteration3d,iteration2d!23-04-14
        write(10+par%rank,*)'-----------------------------------------'!23-04-14
       endif
!     endif
      ...
      if(ksecu==1)then
      write(6,*)'Erreurs mpi notifiees dans fichiers fort locaux'
        stop 'STOP dans atmboundlayer_checkmpi4'
      endif

      end subroutine atmboundlayer_checkmpi4
#endif

!................................................................................................
#ifdef checkmpi
      subroutine atmboundlayer_checkmpi_1dv
      use module_principal
      use module_parallele                                        !#MPI !16-09-09
      implicit none
      ...
      i1=imax/2 ; j1=jmax/2
      do j=1,jmax ; do i=1,imax
       if(teta2delta_t(i,j,1)/=teta2delta_t(i1,j1,1)) then
        write(6,*)'modele 1dv non regulier teta2delta_ten i j =',i,j
        write(6,*)teta2delta_t(i,j,1),teta2delta_t(i1,j1,1)
        stop 'atmboundlayer_checkmpi_1dv'
       endif
       if(q2delta_t(i,j,1)/=q2delta_t(i1,j1,1)) then
        write(6,*)'modele 1dv non regulier q2delta_ten i j =',i,j
        write(6,*)q2delta_t(i,j,1),q2delta_t(i1,j1,1)
        stop 'atmboundlayer_checkmpi_1dv'
       endif
      enddo       ; enddo
      ...
      if(flag_abl2==1) then !abl2abl2>
       do j=1,jmax   ; do i=1,imax   !01-04-16
       if(uwinddelta_t(i,j,1)/=uwinddelta_t(i1,j1,1)) then
        write(6,*)'modele 1dv non regulier uwinddelta_ten i j =',i,j
        write(6,*)uwinddelta_t(i,j,1),uwinddelta_t(i1,j1,1)
        stop 'atmboundlayer_checkmpi_1dv'
       endif
       if(vwinddelta_t(i,j,1)/=vwinddelta_t(i1,j1,1)) then
        write(6,*)'modele 1dv non regulier vwinddelta_ten i j =',i,j
        write(6,*)vwinddelta_t(i,j,1),vwinddelta_t(i1,j1,1)
        stop 'atmboundlayer_checkmpi_1dv'
       endif
       enddo       ; enddo
      endif                 !abl2abl2>

      end subroutine atmboundlayer_checkmpi_1dv
#endif
