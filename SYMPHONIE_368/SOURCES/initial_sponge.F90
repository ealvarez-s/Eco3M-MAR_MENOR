...
#ifdef synopsis
       subroutinetitle='initial_sponge'
       subroutinedescription= &
       'Computes the strenght of restoring force of the lateral nudging'&
       //' and stores the result in sponge_t sponge_u sponge_v'
...
#ifdef synopsis
       subroutinetitle='initial_sponge_hmin'
       subroutinedescription= &
       'h=max(h,h_inf_). Transition of h_inf_ over a 30-points OBC' &
       //' layer from h_inf to h_inf_obc'
       call main_synopsis(subroutinetitle,subroutinedescription)
#endif
...
#ifdef synopsis
       subroutinetitle='initial_sponge_doublon'
       subroutinedescription= &
       'Ckecks that loop bounds of the sponge layer are not redondant'
       call main_synopsis(subroutinetitle,subroutinedescription)
#endif
