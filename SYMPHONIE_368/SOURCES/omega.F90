...
!______________________________________________________________________
      ...
      implicit none
#ifdef synopsis
       subroutinetitle='omega'
       subroutinedescription= &
       'Computes omega, the "sigma relative" vertical velocity'
...
! Le schéma de couplage externe/interne est conservatif mais l'empilement
! de multiples opérations souffre eventuellement de la precision de la machine
! et degrade un peu la conservation. On peut rattraper une partie de la perte de
! de precision en reajustant dz(kmax,before) sur l'equation de continuité.
! Par défaut cette option est deactivée par une etiquette de compilation
       k=kmax                                                         !18-05-10
       do j=1,jmax
       do i=1,imax
...
! On peut verifier que omega(kmax+1) est beaucoup plus proche du zero
! absolu suite à cette manip sur dz(kmax,before)
!     do k=1,kmax
!      do j=1,jmax
!      do i=1,imax
!            omega_w(i    ,j    ,k+kpt,1  )=                    &
