...
!      if(i+par%timax(1)==317.and.j+par%tjmax(1)==59) then 
!       write(10+par%rank,*)'59 ',real(ustar_t(i,j,1)),real(tetastar_t(i,j,1)),real(qstar_t(i,j,1)),loop1
!      endif
!      if(i+par%timax(1)==317.and.j+par%tjmax(1)==62) then
!       write(10+par%rank,*)'62 ',real(ustar_t(i,j,1)),real(tetastar_t(i,j,1)),real(qstar_t(i,j,1)),loop1
!      endif
