...
!     ,z2meatide                           &
      ...
      real*4,dimension(:),allocatable :: &
       drifter_send_nord                 & ! norestart
      ,drifter_recv_nord                 & ! norestart
      ,drifter_send_sud                  & ! norestart
      ,drifter_recv_sud                  & ! norestart
      ,drifter_send_est                  & ! norestart
      ,drifter_recv_est                  & ! norestart
      ,drifter_send_ouest                & ! norestart
      ,drifter_recv_ouest                & ! norestart
      ,drifter_send_nordest              & ! norestart
      ,drifter_send_nordouest            & ! norestart
      ,drifter_send_sudest               & ! norestart
      ,drifter_send_sudouest             & ! norestart
      ,drifter_recv_nordest              & ! norestart
      ,drifter_recv_nordouest            & ! norestart
      ,drifter_recv_sudest               & ! norestart
      ,drifter_recv_sudouest               ! norestart
...
!...........................................................
#ifdef bilan_s_3d
! Declaration pour la subroutine my_outputs_3dsalttempflux
      double precision,dimension(:,:,:),allocatable :: &
       flus       &
      ,flvs       &
      ,fadvus     &
...
!     ,dt_obc                                                        &
      ...
      ,ssh_avr_nest_out                                              &
      ,graphperiod                                                   & !norestart P1
      ,graph_nextime                                                 &
      ,restartfileperiod                                             & !norestart P1
      ,tidenodal_prev_rdv                                            &
      ,tidenodal_next_rdv                                            &
...
!     allocate(noise_velbar_v      (1:imax  ,1:jmax+1)                 ) ; noise_velbar_v=0
      ...
      allocate(taux_w              (-1:imax+2,-1:jmax+2,0:2)           ) ; taux_w=0
      allocate(tauy_w              (-1:imax+2,-1:jmax+2,0:2)           ) ; tauy_w=0
#endif
...
!     allocate(adve3d2d_now_u      (0:imax+1,0:jmax+1)                 ) ; adve3d2d_now_u=0
!     allocate(adve3d2d_now_v      (0:imax+1,0:jmax+1)                 ) ; adve3d2d_now_v=0
!     allocate(adve3d2d_bef_u      (0:imax+1,0:jmax+1)                 ) ; adve3d2d_bef_u=0
!     allocate(adve3d2d_bef_v      (0:imax+1,0:jmax+1)                 ) ; adve3d2d_bef_v=0
...
!     allocate(sqr_goverh_v        (1:imax,2)                          ) ; sqr_goverh_v=0.
!     allocate(sqr_goverh_u        (1:jmax,2)                          ) ; sqr_goverh_u=0.
