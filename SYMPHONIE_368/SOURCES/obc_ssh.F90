...
#ifdef synopsis
       subroutinetitle='obc_ssh'
       subroutinedescription= &
       'Lateral boundary condition on SSH, mpi continuity'
...
#ifdef synopsis
       subroutinetitle='obc_ssh_checkmpi'
       subroutinedescription=' '
       call main_synopsis(subroutinetitle,subroutinedescription)
#endif
...
#ifdef synopsis
       subroutinetitle='obc_sshobc_mpi'
       subroutinedescription=' '
       call main_synopsis(subroutinetitle,subroutinedescription)
#endif
...
!.................................................................
      ...
      integer t_,loop_
#ifdef synopsis
       subroutinetitle='obc_ssh_int_clamped'
       subroutinedescription='Clamped OBC on ssh_int_w(i,j,2)'
       call main_synopsis(subroutinetitle,subroutinedescription)
#endif
...
!.................................................................
      ...
      integer t_,loop_
#ifdef synopsis
       subroutinetitle='obc_ssh_int_0grd'
       subroutinedescription='Zero gradient OBC on ssh_int_w(i,j,2)'
       call main_synopsis(subroutinetitle,subroutinedescription)
#endif
...
!     stop 'obc_ssh_flather_northsouth'
      ...
      if(iteration3d==0) then
       open(unit=3,file='modulo_input')
       read(3,*)modulo_obctest
       close(3)
      endif

      k=kmax
!     x1=0.001*sin(2*pi*elapsedtime_now/period_obctest)*rampe
      do i=1,imax

!     x1=0.001*sin(2*pi*elapsedtime_now/period_obctest   &
!                -2.*pi*real(modulo_obctest*modulo(i+par%timax(1),iglb-2))/real(iglb-2)) &
!       *rampe

      x1=( &
          0.001*sin(2*pi*elapsedtime_now/period_obctest   &
                   -2.*pi*real(0*modulo(i+par%timax(1),iglb-2))/real(iglb-2)) &
         +0.001*sin(2*pi*elapsedtime_now/period_obctest   &
                   -2.*pi*real(8*modulo(i+par%timax(1),iglb-2))/real(iglb-2)) &
         +0.001*sin(2*pi*elapsedtime_now/period_obctest   &
                   -2.*pi*real(14*modulo(i+par%timax(1),iglb-2))/real(iglb-2)) &
        )*rampe

!       ssh_int_w(i,j1,2)=sshobc_w(i,j1,1)
        ssh_int_w(i,j1,2)=x1
...
!        ssh_int_w(i,j1,2)=min(max(                &
!      2*ssh_int_w(i,j3,2)-ssh_int_w(i,j5,2)       &
!       ,min(ssh_int_w(i,j1,1),ssh_int_w(i,j3,2))) &
!       ,max(ssh_int_w(i,j1,1),ssh_int_w(i,j3,2)))  
...
!        ssh_int_w(i,j1,2)= &
!      2*ssh_int_w(i,j3,2)-ssh_int_w(i,j5,2)  & 
!          +(j1-j3)*0.5*(vel_v(i,j2,k,2)+vel_v(i,j4,k,2)) &
!           *((kvectorpeak_i(i,loop1)*dy_t(i,j2))**2)     &
!           *sinh(kvectorpeak_i(i,loop1)*max(0.,                h_w(i,j1))) &
!           /cosh(kvectorpeak_i(i,loop1)*max(1.,depth_t(i,j1,k)+h_w(i,j1))) &
!           /freq2pipeak       
