...
#ifdef bilan_s_3d
      if(allocated(flus))call netcdfrestart_read(flus,'flus',lbound(flus),ubound(flus))
      if(allocated(flvs))call netcdfrestart_read(flvs,'flvs',lbound(flvs),ubound(flvs))
      if(allocated(fadvus))call netcdfrestart_read(fadvus,'fadvus',lbound(fadvus),ubound(fadvus))
      if(allocated(fadvvs))call netcdfrestart_read(fadvvs,'fadvvs',lbound(fadvvs),ubound(fadvvs))
      if(allocated(flws))call netcdfrestart_read(flws,'flws',lbound(flws),ubound(flws))
      if(allocated(flwis))call netcdfrestart_read(flwis,'flwis',lbound(flwis),ubound(flwis))
      if(allocated(difs))call netcdfrestart_read(difs,'difs',lbound(difs),ubound(difs))
      if(allocated(assels))call netcdfrestart_read(assels,'assels',lbound(assels),ubound(assels))
      if(allocated(dxdydzs0))call netcdfrestart_read(dxdydzs0,'dxdydzs0',lbound(dxdydzs0),ubound(dxdydzs0))
      if(allocated(fimplis))call netcdfrestart_read(fimplis,'fimplis',lbound(fimplis),ubound(fimplis))
#endif
...
#ifdef bilan_s_3d
      if(allocated(flus))call netcdfrestart_wrt(flus,'flus',lbound(flus),ubound(flus))
      if(allocated(flvs))call netcdfrestart_wrt(flvs,'flvs',lbound(flvs),ubound(flvs))
      if(allocated(fadvus))call netcdfrestart_wrt(fadvus,'fadvus',lbound(fadvus),ubound(fadvus))
      if(allocated(fadvvs))call netcdfrestart_wrt(fadvvs,'fadvvs',lbound(fadvvs),ubound(fadvvs))
      if(allocated(flws))call netcdfrestart_wrt(flws,'flws',lbound(flws),ubound(flws))
      if(allocated(flwis))call netcdfrestart_wrt(flwis,'flwis',lbound(flwis),ubound(flwis))
      if(allocated(difs))call netcdfrestart_wrt(difs,'difs',lbound(difs),ubound(difs))
      if(allocated(assels))call netcdfrestart_wrt(assels,'assels',lbound(assels),ubound(assels))
      if(allocated(dxdydzs0))call netcdfrestart_wrt(dxdydzs0,'dxdydzs0',lbound(dxdydzs0),ubound(dxdydzs0))
      if(allocated(fimplis))call netcdfrestart_wrt(fimplis,'fimplis',lbound(fimplis),ubound(fimplis))
#endif
...
#ifdef bilan_s_3d
      if(allocated(flus))write(3,*)'flus',1+ubound(flus)-lbound(flus)
      if(allocated(flvs))write(3,*)'flvs',1+ubound(flvs)-lbound(flvs)
      if(allocated(fadvus))write(3,*)'fadvus',1+ubound(fadvus)-lbound(fadvus)
      if(allocated(fadvvs))write(3,*)'fadvvs',1+ubound(fadvvs)-lbound(fadvvs)
      if(allocated(flws))write(3,*)'flws',1+ubound(flws)-lbound(flws)
      if(allocated(flwis))write(3,*)'flwis',1+ubound(flwis)-lbound(flwis)
      if(allocated(difs))write(3,*)'difs',1+ubound(difs)-lbound(difs)
      if(allocated(assels))write(3,*)'assels',1+ubound(assels)-lbound(assels)
      if(allocated(dxdydzs0))write(3,*)'dxdydzs0',1+ubound(dxdydzs0)-lbound(dxdydzs0)
      if(allocated(fimplis))write(3,*)'fimplis',1+ubound(fimplis)-lbound(fimplis)
#endif
