...
#ifdef synopsis
       subroutinetitle='model_3d'
       subroutinedescription='General driver of the iterative phase'
...
! air/sea fluxes:
#ifdef key_oasis_symp_surfex
      il_oasis_time=int(elapsedtime_now-elapsedtime_rst)
      call rcv_fields_from_atm(il_oasis_time) !03-04-15
      call rotation_wind_surfex
#else
      call airseaflux_driver(2)            !10-02-13
#ifdef checkmpi
      if(flag_1dv==1)call check_mpi_1dv_airsea !27-11-15
#endif
#endif
...
#ifdef checkmpi
      if(flag_1dv==1)call check_mpi_1dv_internal !27-11-15
#endif
...
! Couplage surfex
#ifdef key_oasis_symp_surfex
call snd_fields_to_atm(il_oasis_time)
#endif
! Couplage ww3
#ifdef key_oasis_symp_ww3
!if(par%rank==0) write(10,*) 'time_oasis_send' ,il_oasis_time
call snd_fields_to_ww3(il_oasis_time)
#endif
...
!-----------------------------------------------------------------
#ifdef bidon
      subroutine model_3d_mpi_test
      use module_principal
      use module_parallele                                        !#MPI !16-09-09
      implicit none
#ifdef synopsis
       subroutinetitle='model_3d_mpi_test'
       subroutinedescription=' '
       call main_synopsis(subroutinetitle,subroutinedescription)
#endif

      if(iteration3d==kount0-200)then !§§§§§§§§§§§§§§§§§§§§§§§§§§§>

#ifndef bidouille
      write(6,*)'verifier la conservation de la parallelisation'  !31-10-10
      write(6,*)'avec l''etiquette de compilation bidouille'
      stop ' STOP dans model_3d'
#endif
      i9=4    ! nbre procs suivant x    !31-10-10
      j9=8    !            suivant y
      if(nbdom_imax==i9.and.nbdom_jmax==j9) then !AAAAAAAA>
...
!     enddo
      ...
      do loop1=0,i9-1   ! sens i
      do loop2=0,j9-1  ! sens j
      ...
      i10=1000000+(loop1*1000)+loop2
      write(texte30,'(i7)')i10
      texte30(1:1)='g'
      texte30(8:11)='.out'
...
#endif
      write(*,*)'kount-kount0=',iteration3d-kount0
      stop ' verifier t et s depuis model_3d B'

      endif                     !§§§§§§§§§§§§§§§§§§§§§§§§§§§>


      end subroutine model_3d_mpi_test
#endif
!----------------------------------------------------------------------
