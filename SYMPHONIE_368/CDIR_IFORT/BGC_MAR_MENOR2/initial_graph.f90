...
! Début:
!..............................................................................
!      if(grh_out_mi.eq.1)call moyenne_temps(0)                         !29/07/03
!..............................................................................
! reset des tableaux de moyenne temporelle
! Fin.
!..............................................................................
...
!.........................................................................
      ...
      read(3,*)dim_varid                 !19-04-15 
           if(dim_varid==0)dim_varid=160 !19-04-15
           allocate( varid(dim_varid)) ; varid=0
      read(3,*)idate_output     !13-02-10
      read(3,*)const1           !13-02-10
      read(3,*)const1_2           !13-02-10 
      read(3,*)                 !13-02-10

      graphperiod=1.d10
      graphperiod_supp=1.d10
      if(idate_output.eq.1)graphperiod=const1*3600.*24              !15-04-11
      if(idate_output.eq.1)graphperiod_supp=const1_2*3600.*24 !15-04-11
!      print*,'const1',graphperiod,graphperiod_supp 
