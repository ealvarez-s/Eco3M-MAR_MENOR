...
! release 369 - last update: 05-06-23
!______________________________________________________________________
...
!         01-12-18  1-sw dans attribut
! v246    09-02-19  ajout d'attributs generaux
! v246    12-02-19  ajout d'attributs generaux
! v259    16-09-19  ajout iteration finale dans attributs generaux
! v264    24-10-19
! v267    08-11-19 if(texte80(1)(1:8)=='i_index_')k0=0      !pas de masque !08-11-19
!                  if(texte80(1)(1:8)=='j_index_')k0=0      !pas de masque !08-11-19
! v269    24-11-19 ajout d'attributs generaux
! v272    09-01-20 attributs generaux albedo
! v284    22-05-20 flag_stop=1 
! v288    08-09-20 offset dans plus de cas
! v297    02-03-21 empecher count d'etre negatif
! v299    19-03-21 ecrire dans fort
! v300    22-03-21 ajout d'attributs generaux
! v301    25-04-21 Pas de _FillValue si filval=0 afin d'eviter de "NANer" les
!                  vitesses nulles des fichiers short
!         29-04-21 ajout d'attributs generaux
! v309    25-08-21 iadvec_ts_hor
! v348    21-05-22 ajout attributs generaux
! v349    29-06-22 ajout attributs generaux
! v350    20-07-22 ajout attributs generaux
! v369    05-06-23 ajout attributs generaux
!...............................................................................
...
!            if(i1/=-9999)call netcdf_write(txt2_,nf_type_,i2-i1,j2-j1,i1,j1,1)
             if(i1/=-9999)call netcdf_write(txt2_,nf_type_,i2-i1,max(j2-j1,2),i1,j1,1) !02-03-21
             read(3,'(a)',end=42)texte30
             if(texte30(1:7)/=' ......') then !>>>
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      if(filval/=0.) then !oooo> !25-04-21
      ...
      if(var_addoffset/=0.) then !m°v°m> !08-09-20
       ...
       var_addoffset=0. ! remise A la valeur nulle par defaut
      endif                      !m°v°m> !08-09-20
...
!                               , real( anyv3d(1,1,1:kend,3) ))
      ...
      if(ksecu==0)then
       write(10+par%rank,'(a,a)')'pb avec variable netcdf ',trim(texte80(1))
       stop ' erreur fonction nfmpi_put_var dans netcdf.f90'
      endif

      if(status/=0) then !19-03-21
       write(10+par%rank,*)'status error=',status
       write(10+par%rank,*)'variable numero ',count_netcdfvar
       write(10+par%rank,*)trim(texte80(1))
       write(10+par%rank,*)trim(texte80(5))
       write(10+par%rank,*)'dimend',dimend
       write(10+par%rank,*)'start(1:dimend)',start(1:dimend)
       write(10+par%rank,*)'edge(1:dimend)',edge(1:dimend)
...
!       stop ' Stop in netcdf_write_par. Voir fichiers tmp/erreurXXX'
        flag_stop=1 !22-05-20
      endif
      call mpi_allreduce(flag_stop,k0,1,mpi_integer,mpi_sum,par%comm2d,ierr)
      if(k0/=0)stop 'Erreur status netcdf_write see tmp/erreurxxx files'
...
! Variables faisant exception aux regles generales u et v
      ...
      if(texte80(1)(1:8)=='i_index_')k0=0      !pas de masque !08-11-19
      if(texte80(1)(1:8)=='j_index_')k0=0      !pas de masque !08-11-19
...
!.....................................................................
      ...
      texte90='20100101-00h00m00s'
      write(texte90(1:4),'(i4)')datesim(1,1) !12-02-19
      if(datesim(2,1)<10) then ; write(texte90(6:6),'(i1)')datesim(2,1) ; else ; write(texte90(5:6),'(i2)')datesim(2,1) ; endif
      if(datesim(3,1)<10) then ; write(texte90(8:8),'(i1)')datesim(3,1) ; else ; write(texte90(7:8),'(i2)')datesim(3,1) ; endif
      if(datesim(4,1)<10) then ; write(texte90(11:11),'(i1)')datesim(4,1) ; else ; write(texte90(10:11),'(i2)')datesim(4,1) ; endif
      if(datesim(5,1)<10) then ; write(texte90(14:14),'(i1)')datesim(5,1) ; else ; write(texte90(13:14),'(i2)')datesim(5,1) ; endif
      if(datesim(6,1)<10) then ; write(texte90(17:17),'(i1)')datesim(6,1) ; else ; write(texte90(16:17),'(i2)')datesim(6,1) ; endif
      len_=len(trim(texte90))
      status=nfmpi_put_att_text(ncid_,nf_global,'simulation_start_date',len_,texte90) !12-02-19

      write(texte90(1:4),'(i4)')datesim(1,2)
      if(datesim(2,2)<10) then ; write(texte90(6:6),'(i1)')datesim(2,2) ; else ; write(texte90(5:6),'(i2)')datesim(2,2) ; endif
      if(datesim(3,2)<10) then ; write(texte90(8:8),'(i1)')datesim(3,2) ; else ; write(texte90(7:8),'(i2)')datesim(3,2) ; endif
      if(datesim(4,2)<10) then ; write(texte90(11:11),'(i1)')datesim(4,2) ; else ; write(texte90(10:11),'(i2)')datesim(4,2) ; endif
      if(datesim(5,2)<10) then ; write(texte90(14:14),'(i1)')datesim(5,2) ; else ; write(texte90(13:14),'(i2)')datesim(5,2) ; endif
      if(datesim(6,2)<10) then ; write(texte90(17:17),'(i1)')datesim(6,2) ; else ; write(texte90(16:17),'(i2)')datesim(6,2) ; endif
      len_=len(trim(texte90))
      status=nfmpi_put_att_text(ncid_,nf_global,'simulation_end_date__',len_,texte90) !12-02-19

      scalarvalr8(1)=elapsedtime_end/86400. ; len_=1
      status=nfmpi_put_att_double(ncid_,nf_global,'Duration_in_days',nf_double,len_,scalarvalr8) !12-02-19


      scalarvalr8(1)=dti_fw ; len_=1
      if(variable_time_step_txt/='none') then !m°v°m> !24-10-19
      status=nfmpi_put_att_double(ncid_,nf_global &
       ,'Last_value_of_the_internal_time_step',nf_double,len_,scalarvalr8)
      else                                    !m°v°m>
...
! ----- Schema de fermeture turbulente
      ...
      if(iturbulence==3)texte90='0 equation Prandlt' !09-02-19
      if(iturbulence==4)texte90='TKE NEMO'           !09-02-19
      if(iturbulence==5)texte90='TKE NEMO neutral'   !09-02-19
      len_=len(trim(texte90))
      status=nfmpi_put_att_text(ncid_,nf_global                    &
                                     ,'Turbulence_closure_scheme ' & !24-01-17
                                     ,len_,texte90)

       if(iturbulence==0.or. & !21-05-22
          iturbulence==4.or. &
          iturbulence==5) then !pmx>
      scalarvalr8=ctke1
      len_=1
      status=nfmpi_put_att_double(ncid_,nf_global,'ctke1',nf_double,len_,scalarvalr8)
      scalarvalr8=ctke2
      len_=1
      status=nfmpi_put_att_double(ncid_,nf_global,'ctke2',nf_double,len_,scalarvalr8)
       endif                   !pmx>
       ...
       if(tke_surf==0.or.tke_surf==1) then !ooo> !18-01-20
        if(tke_surf==0)texte90='Production Dissipation equilibrium'
        if(tke_surf==1)texte90='Kinetic energy flux from waves'
        len_=len(trim(texte90))
        status=nfmpi_put_att_text(ncid_,nf_global                    &
                                     ,'TKE_surface_boundary_conditions'   &
                                     ,len_,texte90)
...
! ----- Parametrage flux de surface
      ...
      status=nfmpi_put_att_double(ncid_,nf_global,'Relative_Wind_1-Sw',nf_double,len_,scalarvalr8)

       if(flag_steric_effect==1) then !>>>
        texte90='used'
        len_=len(trim(texte90))
        status=nfmpi_put_att_text(ncid_,nf_global      &
                                     ,'Steric_effect_parameterization'  & !28-04-18
                                     ,len_,texte90)
       endif                          !>>>

       if(iwve/=0) then !m°v°m> !24-11-19
        if(iwve==1)texte90='WW3+Michaud2012'
        if(iwve==2)texte90='WW3+McWilliams1999' 
        len_=len(trim(texte90))
        status=nfmpi_put_att_text(ncid_,nf_global,'Short_Waves_Forcing',len_,texte90) 
       endif            !m°v°m> !24-11-19

! free slip or no slip condition
      scalarvalr8(1)=coastal_viscosity ; len_=1
      if(coastal_viscosity>0.) then
       status=nfmpi_put_att_double(ncid_, &
       nf_global,'no_slip_coastal_viscosity',nf_double,len_,scalarvalr8)
      endif

       
! Optique: !09-01-20
       scalarvalint(1)=ialbedo ; len_=1 
       status=nfmpi_put_att_int(ncid_,nf_global                     &
                               ,'ialbedo_on/off',nf_int &
                               ,len_,scalarvalint)
       if(ialbedo==1) then !ooo>
        scalarvalint(1)=albedo_case ; len_=1 
        status=nfmpi_put_att_int(ncid_,nf_global                     &
                                ,'albedo_scheme',nf_int &
                                ,len_,scalarvalint)
       endif               !ooo>
...
! ----- Advection T,S:
       scalarvalint(1)=iadvec_ts_hor ; len_=1  !28-10-19!25-08-21
       status=nfmpi_put_att_int(ncid_,nf_global                     &
                               ,'Advection_parameter_iadvec_ts_hor',nf_int &
                               ,len_,scalarvalint)
       scalarvalint(1)=iadvec_ts_ver ; len_=1  !28-10-19!25-08-21
       status=nfmpi_put_att_int(ncid_,nf_global                     &
                               ,'Advection_parameter_iadvec_ts_ver',nf_int &
                               ,len_,scalarvalint)

      scalarvalr8(1)=quick_coef ; len_=1
      status=nfmpi_put_att_double(ncid_,nf_global & !20-07-22
       ,'Advection_parameter_quick_coef',nf_double,len_,scalarvalr8)

      if(flag_negdif_hor==1) then !pmx> !04-10-21

      scalarvalr8(1)=ratio_negdif_hor ; len_=1
      status=nfmpi_put_att_double(ncid_,nf_global & !29-04-29
       ,'Advection_parameter_ratio_negdif_hor',nf_double,len_,scalarvalr8)

      endif                       !pmx> 


      if(flag_negdif_ver==1) then !ooo> !25-08-21

      scalarvalr8(1)=ratio_negdif_ver ; len_=1
      status=nfmpi_put_att_double(ncid_,nf_global & !29-04-29
       ,'Advection_parameter_ratio_negdif_ver',nf_double,len_,scalarvalr8)

       scalarvalint(1)=quick_filter_points ; len_=1  !20-07-22
       status=nfmpi_put_att_int(ncid_,nf_global                     &
                             ,'Advection_parameter_quick_filter_points',nf_int &
                             ,len_,scalarvalint)

      endif                        !ooo> !25-08-21

       scalarvalint(1)=looplimit_hor ; len_=1  !05-06-23
       status=nfmpi_put_att_int(ncid_,nf_global                     &
       ,'Horizontal_implicit_advection_parameter_looplimit_hor',nf_int &
                             ,len_,scalarvalint)

      endif                       !pmxpxm> !cas nemoffline=0
      ...
      scalarvalint(1)=iteration3d ; len_=1  !16-09-19
      status=nfmpi_put_att_int(ncid_,nf_global                     &
                              ,'Number_of_iterations',nf_int &
                              ,len_,scalarvalint)
