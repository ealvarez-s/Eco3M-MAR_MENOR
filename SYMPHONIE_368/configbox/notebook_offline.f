...
ioffline=0   ! 0=not used    | 1=create files | 2=read files | 3= binary to netcdf conversion
...
directory_offline='../../../REGION/OFFLINE/'
   offlinefile(1)='../../../REGION/OFFLINE/liste_offline.txt'
   offlinefile(2)='none'
   offlinefile(3)='none'
   offlinefile(4)='none'
   offlinefile(5)='none'
...
1.                          2011   12   10   04   00   00  
2.                          2012   01   08   00   00   00  
24.                         2013   01   11   00   00   00  
-999.                       2014   01   15   00   00   00  
