...
texte80(1)='../../../REGION/LIST/list_ww3'

!texte80(1)='../../../REGION/LIST/list_dir'
!texte80(2)='../../../REGION/LIST/list_foc'
!texte80(3)='../../../REGION/LIST/list_hs'
!texte80(4)='../../../REGION/LIST/list_t'
!texte80(5)='../../../REGION/LIST/list_taw'
!texte80(6)='../../../REGION/LIST/list_two'
!texte80(7)='../../../REGION/LIST/list_uss'
!texte80(8)='../../../REGION/LIST/list_hsw'
!texte80(9)='../../../REGION/LIST/list_bhd' ! Bernouilli Head
/
...
#!/bin/bash
DIR=$1
ls $DIR/*nc > ../../../REGION/LIST/list_dir
ls $DIR/*nc > ../../../REGION/LIST/list_foc
ls $DIR/*nc > ../../../REGION/LIST/list_hs
ls $DIR/*nc > ../../../REGION/LIST/list_t
ls $DIR/*nc > ../../../REGION/LIST/list_taw
ls $DIR/*nc > ../../../REGION/LIST/list_two
ls $DIR/*nc > ../../../REGION/LIST/list_uss
ls $DIR/*nc > ../../../REGION/LIST/list_hsw
