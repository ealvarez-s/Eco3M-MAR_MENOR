...
! https://docs.google.com/document/d/1U7DDLl9p1BZzG5NVgp4VWQ1Y6Y0if7Pt7bOjpr5GkfE/edit
      flag_adve2d=0 ! 0=c4+biharm (version1) , 1=upwind , 2=c4+biharm(version2)
! Internal mode: advection scheme for baroclinic velocities
      flag_adve3d=0 ! 0=c4+biharm (version1) , 1=upwind , 2=c4+biharm(version2)

! Advection scheme for biogeochemical and passive tracers
      iadvec_bio=3     ! 3 = QUICKEST

      flag_rmnegval=1     ! 0 = do not remove negative values 
...
!upwindzonefile='../../../REGION/BATHYMASK/central_points_of_upwind_zones.txt'
