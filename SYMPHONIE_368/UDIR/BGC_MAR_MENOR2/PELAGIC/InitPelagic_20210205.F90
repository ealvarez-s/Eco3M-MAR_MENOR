...
! Local variables
      ...
      integer :: npoints_poly, n, polygon_m(mbio1:mbio2,nbio1:nbio2),nmaxprofk(11,10)
...
!     open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS/Albo_phos.dat') !max + faible que pour Alex
      ...
      read(3,*)Init_PRF(1,k),InitVal_PHO(1,k)
      enddo
      close(3)
!     open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS/Albo_sil.dat') ! diminution vers le fond à voir si réaliste
      ...
      read(3,*)Init_PRF(1,k),InitVal_SIL(1,k)
      enddo
      close(3)
!     open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS/moy_alboran.dat') 
      ...
      read(3,*)Init_PRF(1,k),InitVal_OXY(1,k)
      enddo
      close(3)
     open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/mean_bact_inv.txt')
      ...
      InitVal_DOC(1,k)=InitVal_DOC(1,k)-Init_DOC_Refr
      enddo
      close(3)
      ...
      InitVal_DON(1,k)=InitVal_DON(1,k)-Init_DON_Refr
      enddo
      close(3)
...
!     open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS/Alg_phos.dat') ! + faible que dans Alex
      ...
      read(3,*)Init_PRF(2,k),InitVal_PHO(2,k)
      enddo
      close(3)
!     open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS/Alg_sil.dat') ! pas de max à 9 à 1000m comme dans Alex, en meilleur accord avec Tanhua?
      ...
      read(3,*)Init_PRF(2,k),InitVal_SIL(2,k)
      enddo
      close(3)
      ...
      read(3,*)Init_PRF(2,k),InitVal_OXY(2,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/mean_bact_inv.txt')
      ...
      InitVal_DOC(2,k)=InitVal_DOC(2,k)-Init_DOC_Refr
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DON_boum_inv.txt')
      ...
      InitVal_DON(2,k)=InitVal_DON(2,k)-Init_DON_Refr
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DOP_boum_inv.txt')
...
!     open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS/Gdl_phos.dat') ! pas de max dans les eaux intermédiaires (dans Alex le pic était à 0.5!)
      ...
      read(3,*)Init_PRF(3,k),InitVal_PHO(3,k)
      enddo
      close(3)
!     open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS/Gdl_sil.dat') ! idem que nitrate
      ...
      read(3,*)Init_PRF(3,k),InitVal_SIL(3,k)
      enddo
      close(3)
      ...
      read(3,*)Init_PRF(3,k),InitVal_OXY(3,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/mean_bact_inv.txt')
      ...
      InitVal_DOC(3,k)=InitVal_DOC(3,k)-Init_DOC_Refr
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DON_boum_inv.txt')
      ...
      InitVal_DON(3,k)=InitVal_DON(3,k)-Init_DON_Refr
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DOP_boum_inv.txt')
...
!     open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS/Tyr_phos.dat') ! un peu plus faible que dans Alex
      ...
      read(3,*)Init_PRF(4,k),InitVal_PHO(4,k)
      enddo
      close(3)
!     open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS/Tyr_sil.dat') ! un peu plus faible que dans Alex
      ...
      read(3,*)Init_PRF(4,k),InitVal_SIL(4,k)
      enddo
      close(3)
      ...
      read(3,*)Init_PRF(4,k),InitVal_OXY(4,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/mean_bact_inv.txt')
      ...
      InitVal_DOC(4,k)=InitVal_DOC(4,k)-Init_DOC_Refr
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DON_boum_inv.txt')
      ...
      InitVal_DON(4,k)=InitVal_DON(4,k)-Init_DON_Refr
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DOP_boum_inv.txt')
...
!     open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS/Algerob_phos.dat')
      ...
      read(3,*)Init_PRF(5,k),InitVal_PHO(5,k)
      enddo
      close(3)
!     open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS/Algerob_sil.dat')
      ...
      read(3,*)Init_PRF(5,k),InitVal_SIL(5,k)
      enddo
      close(3)
      ...
      read(3,*)Init_PRF(5,k),InitVal_OXY(5,k)
      enddo
      close(3)
     open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/mean_bact_inv.txt')
      ...
      InitVal_DOC(5,k)=InitVal_DOC(5,k)-Init_DOC_Refr
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DON_boum_inv.txt')
      ...
      InitVal_DON(5,k)=InitVal_DON(5,k)-Init_DON_Refr
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DOP_boum_inv.txt')
...
!     open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS/Ion_phos.dat') ! idem que pour nitrate, la valeur du max en meilleur accord avec Tanhua et al 2013
      ...
      read(3,*)Init_PRF(6,k),InitVal_PHO(6,k)
      enddo
      close(3)
!     open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS/Ion_sil.dat') ! semble mieux(moins fort) dans la couche de surface qu'A et F, dans Faycal concentration vraiment tres faible au fond
      ...
      read(3,*)Init_PRF(6,k),InitVal_SIL(6,k)
      enddo
      close(3)
      ...
      read(3,*)Init_PRF(6,k),InitVal_OXY(6,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/Bact_Lev_inv.txt')
      ...
      InitVal_DOC(6,k)=InitVal_DOC(6,k)-Init_DOC_Refr
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DON_boum_inv.txt')
      ...
      InitVal_DON(6,k)=InitVal_DON(6,k)-Init_DON_Refr
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DOP_boum_inv.txt')
...
!     open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS/Adria_phos.dat') ! idem que nit
      ...
      read(3,*)Init_PRF(7,k),InitVal_PHO(7,k)
      enddo
      close(3)
!     open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS/Adria_sil.dat') ! idem que nit
      ...
      read(3,*)Init_PRF(7,k),InitVal_SIL(7,k)
      enddo
      close(3)
      ...
      read(3,*)Init_PRF(7,k),InitVal_OXY(7,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/Bact_Lev_inv.txt')
      ...
      InitVal_DOC(7,k)=InitVal_DOC(7,k)-Init_DOC_Refr
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DON_boum_inv.txt')
      ...
      InitVal_DON(7,k)=InitVal_DON(7,k)-Init_DON_Refr
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DOP_boum_inv.txt')
...
!     open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS/Egee_phos.dat') ! zone pas profonde, plus faible
      ...
      read(3,*)Init_PRF(8,k),InitVal_PHO(8,k)
      enddo
      close(3)
!     open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS/Egee_sil.dat') ! zone pas profonde, comme Faycal
      ...
      read(3,*)Init_PRF(8,k),InitVal_SIL(8,k)
      enddo
      close(3)
      ...
      read(3,*)Init_PRF(8,k),InitVal_OXY(8,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/Bact_Lev_inv.txt')
      ...
      InitVal_DOC(8,k)=InitVal_DOC(8,k)-Init_DOC_Refr
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DON_boum_inv.txt')
      ...
      InitVal_DON(8,k)=InitVal_DON(8,k)-Init_DON_Refr
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DOP_boum_inv.txt')
...
!     open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS/Lev_phos.dat') ! idem que nitrate
      ...
      read(3,*)Init_PRF(9,k),InitVal_PHO(9,k)
      enddo
      close(3)
!     open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS/Lev_sil.dat') 
      ...
      read(3,*)Init_PRF(9,k),InitVal_SIL(9,k)
      enddo
      close(3)
      ...
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS_092020/LEV_oxy.dat')
      read(3,*)nmaxprofk(9,6)
      do k=1,nmaxprofk(9,6)
      read(3,*)Init_PRF(9,k),InitVal_OXY(9,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/Bact_Lev_inv.txt')
      ...
      InitVal_DOC(9,k)=InitVal_DOC(9,k)-Init_DOC_Refr
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DON_boum_inv.txt')
      ...
      InitVal_DON(9,k)=InitVal_DON(9,k)-Init_DON_Refr
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DOP_boum_inv.txt')
...
!     open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS/Lig_sil.dat')
      ...
      read(3,*)Init_PRF(10,k),InitVal_OXY(10,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/mean_bact_inv.txt')
      ...
      InitVal_DOC(9,k)=InitVal_DOC(10,k)-Init_DOC_Refr
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DON_boum_inv.txt')
      ...
      InitVal_DON(9,k)=InitVal_DON(10,k)-Init_DON_Refr
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DOP_boum_inv.txt')
...
!           print*,'sil',polygon_m(i,j), nmaxprofk(polygon_m(i,j),3)
...
!           print*,'nut',depth_t(i,j,k),Init_PRF(polygon_m(i,j),nmaxprofk(polygon_m(i,j),1))
!           print*,'nut2',InitVal_NIT(polygon_m(i,j),nmaxprofk(polygon_m(i,j),1)),InitVal_PHO(polygon_m(i,j),nmaxprofk(polygon_m(i,j),2)), &
!           InitVal_SIL(polygon_m(i,j),nmaxprofk(polygon_m(i,j),3)),InitVal_OXY(polygon_m(i,j),nmaxprofk(polygon_m(i,j),6))
         else
