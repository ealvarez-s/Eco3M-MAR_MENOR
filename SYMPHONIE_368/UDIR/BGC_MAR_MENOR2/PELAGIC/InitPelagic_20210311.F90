...
! Local variables
      ...
      integer :: npoints_poly, n, polygon_m(mbio1:mbio2,nbio1:nbio2),nmaxprofk(11,15)
...
!     open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS/moy_alboran.dat') 
     ...
     open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/mean_bact_inv.txt')
      ...
      read(3,*)nmaxprofk(1,14)
      do k=1,nmaxprofk(1,14)
      read(3,*)Init_PRF_MICRO(1,k),InitVal_PICO(1,k)
      enddo
      close(3)
