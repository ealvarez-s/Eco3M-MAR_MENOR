...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 ...
 ! (the rate of changes)
      ...
      dSILICE(NUMPELAGICBOXES)                                          
        DOUBLE PRECISION :: &
      dDIC(NUMPELAGICBOXES),dALKALINITY(NUMPELAGICBOXES)
        DOUBLE PRECISION :: &
      PPBI(NUMPELAGICBOXES),GRAZCI(NUMPELAGICBOXES),                   &
      GRAZCNI(NUMPELAGICBOXES),GRAZCMII(NUMPELAGICBOXES),                   &
      GRAZCMEI(NUMPELAGICBOXES),                   &
      RESPCI(NUMPELAGICBOXES),EXUCI(NUMPELAGICBOXES),                  &
      MORTCI(NUMPELAGICBOXES),GRAZHERBII(NUMPELAGICBOXES),             &
      RESPCPI(NUMPELAGICBOXES),RESPCZI(NUMPELAGICBOXES),               &
      RESPCBI(NUMPELAGICBOXES),GBACI(NUMPELAGICBOXES),                 &
      NITRIFI(NUMPELAGICBOXES),PPBPI(NUMPELAGICBOXES),                 &
      PPBNI(NUMPELAGICBOXES),UPTNITI(NUMPELAGICBOXES),                  &
      PPBMI(NUMPELAGICBOXES),RESPCPPI(NUMPELAGICBOXES),                 &
      RESPCPNI(NUMPELAGICBOXES),RESPCPMI(NUMPELAGICBOXES),              &
      RESPCZNI(NUMPELAGICBOXES),RESPCZMII(NUMPELAGICBOXES),              &
      RESPCZMEI(NUMPELAGICBOXES),MESSYFEEDCMODI(NUMPELAGICBOXES),        &
      MORTBACTI(NUMPELAGICBOXES),REMMOPCI(NUMPELAGICBOXES)
        DOUBLE PRECISION :: &
      ...
      dAMMONIUM,dPHOSPHATE,dSILICE,dOXYGEN,dODU,dDIC,dALKALINITY                                    
        COMMON /XCBDSVAR/    &
      PPBI,GRAZCI,RESPCI,EXUCI,MORTCI,GRAZHERBII,RESPCPI,RESPCZI,      &
      RESPCBI,GBACI,NITRIFI,PPBPI,PPBNI,PPBMI,RESPCPPI,RESPCPNI,       &
      RESPCPMI,GRAZCNI,GRAZCMII,GRAZCMEI,RESPCZNI,RESPCZMII,RESPCZMEI, &
      MESSYFEEDCMODI,MORTBACTI,REMMOPCI,UPTNITI  
...
!!!!!!!!!!!!!!!!!!!!!!!!
 ...
 ! Ordinary variables and units
       ...
       DOUBLE PRECISION ::    & 
         ...
         SALINITY(NUMPELAGICBOXES)             , & ! -
         DENSECO(NUMPELAGICBOXES)              , & ! KG/M3
         MEANTEMPERATURE                       , & ! DGC                                                                
         ...
         TOTALBACTEXCNH4DEEP               , &
         TOTALEXCZOOAMMODEEP               , &
         TOTALBACTEXCPO4TOPLAYER           ,&
         TOTALBACTUPTPTOPLAYER           ,&
         TOTALBACTUPTPINT           ,&
         TOTALBACTUPTPDEEP           ,&
         TOTALBACTUPTAMMOTOPLAYER           ,&
         TOTALBACTUPTAMMOINT           ,&
         TOTALBACTUPTAMMODEEP           ,&
         TOTALBACTEXCPO4INT          ,&
         TOTALBACTEXCPO4DEEP           ,&
         TOTALEXCZOOPO4TOPLAYER           ,&
         TOTALEXCZOOPO4INT           ,&
         TOTALEXCZOOPO4DEEP           ,&
         TOTALEXUSITOPLAYER           ,&
         TOTALEXUSIINT           ,&
         ...
         TOTALNITRIFINT      ,&
         TOTALNITRIFDEEP     ,&
         TOTALREMSMOPSITOPLAYER      ,&
         TOTALREMSMOPSIINT      ,&
         TOTALREMSMOPSIDEEP     ,&
         TOTALREMLMOPSITOPLAYER      ,&
         TOTALREMLMOPSIINT      ,&
         TOTALREMLMOPSIDEEP     ,&
         TOTALNITRIFCOLUMN                     , &
         MASKBIO(NUMPELAGICBOXES)                    , &
         ...
         KNHS(NUMPELAGICBOXES)                  , & ! -                                                                   
         K1H3PO4(NUMPELAGICBOXES)               , & ! -                                                                   
         K2H3PO4(NUMPELAGICBOXES)               , & ! -                                                                   
         K3H3PO4(NUMPELAGICBOXES)               , & ! -
         K1CO2(NUMPELAGICBOXES)               , & ! -
         K2CO2(NUMPELAGICBOXES)               , & ! -
         PCO2(NUMPELAGICBOXES)                  , & ! µATM                                                                
      ...
      EUPHOTICLAYERDEPTH,SALINITY,DENSECO                          
        COMMON /XCBVAR/     &  
      ...
      TOTALBACTEXCNH4TOPLAYER,TOTALBACTEXCNH4INT,TOTALBACTEXCNH4DEEP,  &
      TOTALBACTUPTPTOPLAYER,TOTALBACTUPTPINT,TOTALBACTUPTPDEEP, &
      TOTALBACTUPTAMMOTOPLAYER,TOTALBACTUPTAMMOINT,TOTALBACTUPTAMMODEEP, &
      TOTALEXCZOOAMMOTOPLAYER,TOTALEXCZOOAMMOINT,TOTALEXCZOOAMMODEEP,  &
      TOTALBACTEXCPO4TOPLAYER,TOTALBACTEXCPO4INT,TOTALBACTEXCPO4DEEP,  &
      TOTALEXCZOOPO4TOPLAYER,TOTALEXCZOOPO4INT,TOTALEXCZOOPO4DEEP,     &
      TOTALEXUSITOPLAYER,TOTALEXUSIINT,TOTALEXUSIDEEP,                 &
      TOTALUPTNITTOPLAYER,TOTALUPTNITINT,TOTALUPTNITDEEP,              &
      TOTALUPTPTOPLAYER,TOTALUPTPINT,TOTALUPTPDEEP,                    &
      TOTALUPTSITOPLAYER,TOTALUPTSIINT,TOTALUPTSIDEEP,                 &
      TOTALNITRIFTOPLAYER,TOTALNITRIFINT,TOTALNITRIFDEEP,              &
      TOTALREMSMOPSITOPLAYER,TOTALREMSMOPSIINT,TOTALREMSMOPSIDEEP,     &
      TOTALREMLMOPSITOPLAYER,TOTALREMLMOPSIINT,TOTALREMLMOPSIDEEP 
        COMMON /XCBVAR/     &  
      ...
      TOTALMORTPHYTON,TOTALMORTPHYTOP,LIMITATIONBACT,VBACTEXCPO4        
        COMMON /XCBVAR/     &
      KNHS,K1H3PO4,K2H3PO4,K3H3PO4,PCO2,CO2,HCO3,CO3,PH,MEANITERATIONS, & ! #
         MEANRESOLUTION
        COMMON /XCBVAR/     &  
...
#ifdef mes
        INTEGER, PARAMETER :: XSVARDECLARE     =           38
#else
        INTEGER, PARAMETER :: XSVARDECLARE     =           37
#endif
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      INTEGER, PARAMETER ::  IZOONANOC  =  1
      INTEGER, PARAMETER ::  IZOOMICROC =  2
      INTEGER, PARAMETER ::  IZOOMESOC  =  3
      INTEGER, PARAMETER ::  ISYNEC     =  4
      INTEGER, PARAMETER ::  ISYNEN     =  5
      INTEGER, PARAMETER ::  ISYNEP     =  6
      INTEGER, PARAMETER ::  ISYNECHL   =  7
      INTEGER, PARAMETER ::  INANOC     =  8
      INTEGER, PARAMETER ::  INANON     =  9
      INTEGER, PARAMETER ::  INANOP     = 10
      INTEGER, PARAMETER ::  INANOCHL   = 11
      INTEGER, PARAMETER ::  IDIAC      = 12
      INTEGER, PARAMETER ::  IDIAN      = 13
      INTEGER, PARAMETER ::  IDIAP      = 14
      INTEGER, PARAMETER ::  IDIACHL    = 15
      INTEGER, PARAMETER ::  IDIASI     = 16
      INTEGER, PARAMETER ::  IBACTC     = 17
      INTEGER, PARAMETER ::  ISMOPC     = 18
      INTEGER, PARAMETER ::  ISMOPN     = 19
      INTEGER, PARAMETER ::  ISMOPP     = 20
      INTEGER, PARAMETER ::  ISMOPCHL   = 21
      INTEGER, PARAMETER ::  ISMOPSI    = 22
      INTEGER, PARAMETER ::  ILMOPC     = 23
      INTEGER, PARAMETER ::  ILMOPN     = 24
      INTEGER, PARAMETER ::  ILMOPP     = 25
      INTEGER, PARAMETER ::  ILMOPSI    = 26
      INTEGER, PARAMETER ::  IMODC      = 27
      INTEGER, PARAMETER ::  IMODN      = 28
      INTEGER, PARAMETER ::  IMODP      = 29
      INTEGER, PARAMETER ::  INITRATE   = 30
      INTEGER, PARAMETER ::  IAMMONIUM  = 31
      INTEGER, PARAMETER ::  IPHOSPHATE = 32
      INTEGER, PARAMETER ::  ISILICE    = 33
      INTEGER, PARAMETER ::  IOXYGEN    = 34
      INTEGER, PARAMETER ::  IODU       = 35
      INTEGER, PARAMETER ::  IDIC       = 36
      INTEGER, PARAMETER ::  IALKALINITY= 37
