...
!    open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILNUTS/interp_oxyg_EST2.txt')
     open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILNUTS/interp_oxyg_EST3.txt') ! modifié le 5/5/2020 pour etre plus en accord avec les Argo
      do k=1,nmax4
      read(3,*)InitValue_EST(1,k),Prof_oxyg(1,k)
      enddo
      close(3)

!     open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILNUTS/OXYGEN_WEST.txt')
!     open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILNUTS/InitOxyDyf201008.txt')
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILNUTS/InitOxyDyf201108_ss1l.txt') ! modifié le 5/5/2020
      do k=1,nmax6
      read(3,*)InitValue_WEST(1,k),Prof_oxyg_WEST(1,k)
      enddo
      close(3)

! Ajouté le 11 mai 2020 début
!     open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/mean_DOC_Lev.txt')
!      do k=1,nmax10
!      read(3,*)Prof_EST_doc(1,k),InitValue_EST_DOC(1,k)
!      enddo
!      close(3)
!
!      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/mean_DOC.txt')
!      do k=1,nmax11
!      read(3,*)Prof_WEST_doc(1,k),InitValue_WEST_DOC(1,k)
!      enddo
!      close(3)
!
!     open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/Bact_Lev_inv.txt')
!      do k=1,nmax12
!      read(3,*)Prof_EST_bact(1,k),InitValue_EST_bact(1,k)
!      enddo
!      close(3)
!
!      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/mean_bact_inv.txt')
!      do k=1,nmax13
!      read(3,*)Prof_WEST_bact(1,k),InitValue_WEST_bact(1,k)
!      enddo
!      close(3)
! Ajouté le 11 mai 2020 fin




      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILNUTS/interp_DIC_EST.txt')
      do k=1,nmax4
      read(3,*)InitValue_EST_DIC(1,k),Prof_oxyg(1,k)
      enddo
      close(3)
! dic
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILNUTS/interp_DIC_WEST.txt')
      do k=1,nmax4
      read(3,*)InitDIC(1,k),ProfDIC(1,k)
      enddo
      close(3)

     open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILNUTS/interp_DIC_EST_WEST.txt')
      do k=1,nmax4
      read(3,*)InitDIC(3,k),ProfDIC(3,k)
      enddo
      close(3)

     open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILNUTS/interp_DIC_EST_EST.txt')
      do k=1,nmax4
     ...
     open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILNUTS/interp_DIC_GLT.txt')
      do k=1,nmax4
...
!     open(unit=3,file='/tmpdir/culses/Dewex/Data/DyfamedmeanDIC.txt')
      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/DyfamedmeanDIC.txt')
      do k=1,nmax5
...
! alk
     open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILNUTS/interp_ALK_WEST.txt')
      do k=1,nmax4
      read(3,*)InitTAlk(1,k),ProfTAlk(1,k)
      enddo
      close(3)

     open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILNUTS/interp_ALK_EST_WEST.txt')
      do k=1,nmax4
      read(3,*)InitTAlk(3,k),ProfTAlk(3,k)
      enddo
      close(3)

     open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILNUTS/interp_ALK_EST_EST.txt')
      do k=1,nmax4
      read(3,*)InitTAlk(4,k),ProfTAlk(4,k)
      enddo
      close(3)

     open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILNUTS/interp_ALK_GLT.txt')
      do k=1,nmax4
...
!     open(unit=3,file='/tmpdir/culses/Dewex/Data/DyfamedmeanTAlk.txt')
      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/DyfamedmeanTAlk.txt')
      do k=1,nmax5
      read(3,*)ProfTAlk(2,k),InitTAlk(2,k)
      enddo
      close(3)

! load Oxygene Bassin Fayçal 

! cyp

      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILNUTS/interp_oxyg_cyp.txt')
      do k=1,nmax4
...
! ion
      ...
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILNUTS/interp_oxyg_ion.txt')
      do k=1,nmax4
...
! lib
      ...
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILNUTS/interp_oxyg_lib.txt')
      do k=1,nmax4
...
! tun
      ...
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILNUTS/interp_oxyg_tun.txt')
      do k=1,nmax4
...
! sic
      ...
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILNUTS/interp_oxyg_sic.txt')
      do k=1,nmax4
...
! nad
      ...
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILNUTS/interp_oxyg_nad.txt')
      do k=1,nmax4
...
! sad
      ...
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILNUTS/interp_oxyg_sad.txt')
      do k=1,nmax4
...
! mlt
      ...
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILNUTS/interp_oxyg_mlt.txt')
      do k=1,nmax4
...
! ege
      ...
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILNUTS/interp_oxyg_ege.txt')
      do k=1,nmax4
...
!     open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS/moy_alboran.dat') 
      ...
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/OXY_2021/ALB_oxy.dat')
      ...
      close(3)
!     open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/mean_bact_inv.txt')
      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/mean_bact2_inv.txt')
      read(3,*)nmaxprofk(1,7)
      do k=1,nmaxprofk(1,7)
      read(3,*)Init_PRF_bact(1,k),InitVal_bact(1,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DOC_boum_inv.txt')
      read(3,*)nmaxprofk(1,8)
      do k=1,nmaxprofk(1,8)
      read(3,*)Init_PRF_doc(1,k),x1,InitVal_DOC(1,k)
      InitVal_DOC(1,k)=max(InitVal_DOC(1,k)-Init_DOC_Refr,0.)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DON_boum_inv.txt')
      read(3,*)nmaxprofk(1,9)
      do k=1,nmaxprofk(1,9)
      read(3,*)Init_PRF_don(1,k),x1,InitVal_DON(1,k)
      InitVal_DON(1,k)=max(InitVal_DON(1,k)-Init_DON_Refr,0.)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DOP_boum_inv.txt')
      read(3,*)nmaxprofk(1,10)
      do k=1,nmaxprofk(1,10)
      read(3,*)Init_PRF_dop(1,k),x1,InitVal_DOP(1,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS_022021/ALB_chl.dat')
      read(3,*)nmaxprofk(1,11)
      do k=1,nmaxprofk(1,11)
      read(3,*)Init_PRF_CHL(1,k),InitVal_CHL(1,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PHYTO_POURCENT022021/ALG_micro.dat')
      read(3,*)nmaxprofk(1,12)
      do k=1,nmaxprofk(1,12)
      read(3,*)Init_PRF_MICRO(1,k),InitVal_MICRO(1,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PHYTO_POURCENT022021/ALG_nano.dat')
      read(3,*)nmaxprofk(1,13)
      do k=1,nmaxprofk(1,13)
      read(3,*)Init_PRF_MICRO(1,k),InitVal_NANO(1,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/POM_SW_inv.txt')
      read(3,*)nmaxprofk(1,15)
      do k=1,nmaxprofk(1,15)
      read(3,*)Init_PRF_POM(1,k),InitVal_POC(1,k),InitVal_PON(1,k),InitVal_POP(1,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/ZOO_20/W_nano.dat')
      read(3,*)nmaxprofk(1,16)
      do k=1,nmaxprofk(1,16)
      read(3,*)Init_PRF_NANOZOO(1,k),InitVal_NANOZOO(1,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/ZOO_20/W_micro.dat')
      read(3,*)nmaxprofk(1,17)
      do k=1,nmaxprofk(1,17)
      read(3,*)Init_PRF_NANOZOO(1,k),InitVal_MICROZOO(1,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/ZOO_20/SW_meso.dat')
      read(3,*)nmaxprofk(1,18)
      do k=1,nmaxprofk(1,18)
      read(3,*)Init_PRF_MESO(1,k),InitVal_MESOZOO(1,k)
      enddo
      close(3)
...
!     open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS_092020/ALG_sil.dat')
      ...
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/OXY_2021/ALGER_oxy.dat')
...
!      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/mean_bact_inv.txt')
      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/mean_bact2_inv.txt')
      read(3,*)nmaxprofk(2,7)
      do k=1,nmaxprofk(2,7)
      read(3,*)Init_PRF_bact(2,k),InitVal_bact(2,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DOC_boum_inv.txt')
      read(3,*)nmaxprofk(2,8)
      do k=1,nmaxprofk(2,8)
      read(3,*)Init_PRF_doc(2,k),x1,InitVal_DOC(2,k)
      InitVal_DOC(2,k)=max(InitVal_DOC(2,k)-Init_DOC_Refr,0.)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DON_boum_inv.txt')
      read(3,*)nmaxprofk(2,9)
      do k=1,nmaxprofk(2,9)
      read(3,*)Init_PRF_don(2,k),x1,InitVal_DON(2,k)
      InitVal_DON(2,k)=max(InitVal_DON(2,k)-Init_DON_Refr,0.)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DOP_boum_inv.txt')
      read(3,*)nmaxprofk(2,10)
      do k=1,nmaxprofk(2,10)
      read(3,*)Init_PRF_dop(2,k),x1,InitVal_DOP(2,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS_022021/ALG_chl.dat')
      read(3,*)nmaxprofk(2,11)
      do k=1,nmaxprofk(2,11)
      read(3,*)Init_PRF_CHL(2,k),InitVal_CHL(2,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PHYTO_POURCENT022021/ALG_micro.dat')
      read(3,*)nmaxprofk(2,12)
      do k=1,nmaxprofk(2,12)
      read(3,*)Init_PRF_MICRO(2,k),InitVal_MICRO(2,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PHYTO_POURCENT022021/ALG_nano.dat')
      read(3,*)nmaxprofk(2,13)
      do k=1,nmaxprofk(2,13)
      read(3,*)Init_PRF_MICRO(2,k),InitVal_NANO(2,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PHYTO_POURCENT022021/ALG_pico.dat')
      read(3,*)nmaxprofk(2,14)
      do k=1,nmaxprofk(2,14)
      read(3,*)Init_PRF_MICRO(2,k),InitVal_PICO(2,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/POM_SW_inv.txt')
      read(3,*)nmaxprofk(2,15)
      do k=1,nmaxprofk(2,15)
      read(3,*)Init_PRF_POM(2,k),InitVal_POC(2,k),InitVal_PON(2,k),InitVal_POP(2,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/ZOO_20/W_nano.dat')
      read(3,*)nmaxprofk(2,16)
      do k=1,nmaxprofk(2,16)
      read(3,*)Init_PRF_NANOZOO(2,k),InitVal_NANOZOO(2,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/ZOO_20/W_micro.dat')
      read(3,*)nmaxprofk(2,17)
      do k=1,nmaxprofk(2,17)
      read(3,*)Init_PRF_NANOZOO(2,k),InitVal_MICROZOO(2,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/ZOO_20/SW_meso.dat')
      read(3,*)nmaxprofk(2,18)
      do k=1,nmaxprofk(2,18)
      read(3,*)Init_PRF_MESO(2,k),InitVal_MESOZOO(2,k)
      enddo
      close(3)  
...
!     open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS_092020/GDL_sil.dat')
      ...
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/OXY_2021/GDL_oxy.dat')
...
!      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/mean_bact_inv.txt')
      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/mean_bact2_inv.txt')
      read(3,*)nmaxprofk(3,7)
      do k=1,nmaxprofk(3,7)
      read(3,*)Init_PRF_bact(3,k),InitVal_bact(3,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DOC_boum_inv.txt')
      read(3,*)nmaxprofk(3,8)
      do k=1,nmaxprofk(3,8)
      read(3,*)Init_PRF_doc(3,k),InitVal_DOC(3,k)
      InitVal_DOC(3,k)=max(InitVal_DOC(3,k)-Init_DOC_Refr,0.)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DON_boum_inv.txt')
      read(3,*)nmaxprofk(3,9)
      do k=1,nmaxprofk(3,9)
      read(3,*)Init_PRF_don(3,k),InitVal_DON(3,k)
      InitVal_DON(3,k)=max(InitVal_DON(3,k)-Init_DON_Refr,0.)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DOP_boum_inv.txt')
      do k=1,nmaxprofk(3,3)
      read(3,*)Init_PRF_dop(3,k),InitVal_DOP(3,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS/caro_moy_DIC_gdl.dat')  
      read(3,*)nmaxprofk(3,4)
...
!      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/mean_bact_inv.txt')
      ...
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DOP_boum_inv.txt')
      read(3,*)nmaxprofk(3,10)
      do k=1,nmaxprofk(3,10)
      read(3,*)Init_PRF_dop(3,k),InitVal_DOP(3,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS_022021/GDL_chl.dat')
      read(3,*)nmaxprofk(3,11)
      do k=1,nmaxprofk(3,11)
      read(3,*)Init_PRF_CHL(3,k),InitVal_CHL(3,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PHYTO_POURCENT022021/GDL_micro.dat')
      read(3,*)nmaxprofk(3,12)
      do k=1,nmaxprofk(3,12)
      read(3,*)Init_PRF_MICRO(3,k),InitVal_MICRO(3,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PHYTO_POURCENT022021/GDL_nano.dat')
      read(3,*)nmaxprofk(3,13)
      do k=1,nmaxprofk(3,13)
      read(3,*)Init_PRF_MICRO(3,k),InitVal_NANO(3,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PHYTO_POURCENT022021/GDL_pico.dat')
      read(3,*)nmaxprofk(3,14)
      do k=1,nmaxprofk(3,14)
      read(3,*)Init_PRF_MICRO(3,k),InitVal_PICO(3,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/POM_NW_inv.txt')
      read(3,*)nmaxprofk(3,15)
      do k=1,nmaxprofk(3,15)
      read(3,*)Init_PRF_POM(3,k),InitVal_POC(3,k),InitVal_PON(3,k),InitVal_POP(3,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/ZOO_20/W_nano.dat')
      read(3,*)nmaxprofk(3,16)
      do k=1,nmaxprofk(3,16)
      read(3,*)Init_PRF_NANOZOO(3,k),InitVal_NANOZOO(3,k)
      enddo
       close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/ZOO_20/W_micro.dat')
      read(3,*)nmaxprofk(3,17)
      do k=1,nmaxprofk(3,17)
      read(3,*)Init_PRF_NANOZOO(3,k),InitVal_MICROZOO(3,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/ZOO_20/NW_meso.dat')
      read(3,*)nmaxprofk(3,18)
      do k=1,nmaxprofk(3,18)
      read(3,*)Init_PRF_MESO(3,k),InitVal_MESOZOO(3,k)
      enddo
      close(3)
...
!      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS_092020/TYRR_sil.dat')
     open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS_022021/TYRR_sil.dat')
      ...
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/OXY_2021/TYRR_oxy.dat')
...
!      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/mean_bact_inv.txt')
      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/mean_bact2_inv.txt')
      read(3,*)nmaxprofk(4,7)
      do k=1,nmaxprofk(4,7)
      read(3,*)Init_PRF_bact(4,k),InitVal_bact(4,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DOC_boum_inv.txt')
      read(3,*)nmaxprofk(4,8)
      do k=1,nmaxprofk(4,8)
      read(3,*)Init_PRF_doc(4,k),x1,InitVal_DOC(4,k)
      InitVal_DOC(4,k)=max(InitVal_DOC(4,k)-Init_DOC_Refr,0.)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DON_boum_inv.txt')
      read(3,*)nmaxprofk(4,9)
      do k=1,nmaxprofk(4,9)
      read(3,*)Init_PRF_don(4,k),x1,InitVal_DON(4,k)
      InitVal_DON(4,k)=max(InitVal_DON(4,k)-Init_DON_Refr,0.)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DOP_boum_inv.txt')
      read(3,*)nmaxprofk(4,10)
      do k=1,nmaxprofk(4,10)
      read(3,*)Init_PRF_dop(4,k),x1,InitVal_DOP(4,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS_022021/TYRR_chl.dat')
      read(3,*)nmaxprofk(4,11)
      do k=1,nmaxprofk(4,11)
      read(3,*)Init_PRF_CHL(4,k),InitVal_CHL(4,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PHYTO_POURCENT022021/TYRR_micro.dat')
      read(3,*)nmaxprofk(4,12)
      do k=1,nmaxprofk(4,12)
      read(3,*)Init_PRF_MICRO(4,k),InitVal_MICRO(4,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PHYTO_POURCENT022021/TYRR_nano.dat')
      read(3,*)nmaxprofk(4,13)
      do k=1,nmaxprofk(4,13)
      read(3,*)Init_PRF_MICRO(4,k),InitVal_NANO(4,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PHYTO_POURCENT022021/TYRR_pico.dat')
      read(3,*)nmaxprofk(4,14)
      do k=1,nmaxprofk(4,14)
      read(3,*)Init_PRF_MICRO(4,k),InitVal_PICO(4,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/POM_SW_inv.txt')
      read(3,*)nmaxprofk(4,15)
      do k=1,nmaxprofk(4,15)
      read(3,*)Init_PRF_POM(4,k),InitVal_POC(4,k),InitVal_PON(4,k),InitVal_POP(4,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/ZOO_20/W_nano.dat')
      read(3,*)nmaxprofk(4,16)
      do k=1,nmaxprofk(4,16)
      read(3,*)Init_PRF_NANOZOO(4,k),InitVal_NANOZOO(4,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/ZOO_20/W_micro.dat')
      read(3,*)nmaxprofk(4,17)
      do k=1,nmaxprofk(4,17)
      read(3,*)Init_PRF_NANOZOO(4,k),InitVal_MICROZOO(4,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/ZOO_20/SW_meso.dat')
      read(3,*)nmaxprofk(4,18)
      do k=1,nmaxprofk(4,18)
      read(3,*)Init_PRF_MESO(4,k),InitVal_MESOZOO(4,k)
      enddo
      close(3)
...
!     open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS_092020/ALGEROBAL_sil.dat')
      ...
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/OXY_2021/LIG_oxy.dat')
...
!     open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/mean_bact_inv.txt')
      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/mean_bact2_inv.txt')
      read(3,*)nmaxprofk(5,7)
      do k=1,nmaxprofk(5,7)
      read(3,*)Init_PRF_bact(5,k),InitVal_bact(5,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DOC_boum_inv.txt')
      read(3,*)nmaxprofk(5,8)
      do k=1,nmaxprofk(5,8)
      read(3,*)Init_PRF_doc(5,k),InitVal_DOC(5,k)
      InitVal_DOC(5,k)=max(InitVal_DOC(5,k)-Init_DOC_Refr,0.)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DON_boum_inv.txt')
      read(3,*)nmaxprofk(5,9)
      do k=1,nmaxprofk(5,9)
      read(3,*)Init_PRF_don(5,k),InitVal_DON(5,k)
      InitVal_DON(5,k)=max(InitVal_DON(5,k)-Init_DON_Refr,0.)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DOP_boum_inv.txt')
      read(3,*)nmaxprofk(5,10)
      do k=1,nmaxprofk(5,10)
      read(3,*)Init_PRF_dop(5,k),InitVal_DOP(5,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS_022021/ALGEROB_chl.dat')
      read(3,*)nmaxprofk(5,11)
      do k=1,nmaxprofk(5,11)
      read(3,*)Init_PRF_CHL(5,k),InitVal_CHL(5,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PHYTO_POURCENT022021/ALGEROB_micro.dat')
      read(3,*)nmaxprofk(5,12)
      do k=1,nmaxprofk(5,12)
      read(3,*)Init_PRF_MICRO(5,k),InitVal_MICRO(5,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PHYTO_POURCENT022021/ALGEROB_nano.dat')
      read(3,*)nmaxprofk(5,13)
      do k=1,nmaxprofk(5,13)
      read(3,*)Init_PRF_MICRO(5,k),InitVal_NANO(5,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PHYTO_POURCENT022021/ALGEROB_pico.dat')
      read(3,*)nmaxprofk(5,14)
      do k=1,nmaxprofk(5,14)
      read(3,*)Init_PRF_MICRO(5,k),InitVal_PICO(5,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/POM_SW_inv.txt')
      read(3,*)nmaxprofk(5,15)
      do k=1,nmaxprofk(5,15)
      read(3,*)Init_PRF_POM(5,k),InitVal_POC(5,k),InitVal_PON(5,k),InitVal_POP(5,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/ZOO_20/W_nano.dat')
      read(3,*)nmaxprofk(5,16)
      do k=1,nmaxprofk(5,16)
      read(3,*)Init_PRF_NANOZOO(5,k),InitVal_NANOZOO(5,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/ZOO_20/W_micro.dat')
      read(3,*)nmaxprofk(5,17)
      do k=1,nmaxprofk(5,17)
      read(3,*)Init_PRF_NANOZOO(5,k),InitVal_MICROZOO(5,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/ZOO_20/SW_meso.dat')
      read(3,*)nmaxprofk(5,18)
      do k=1,nmaxprofk(5,18)
      read(3,*)Init_PRF_MESO(5,k),InitVal_MESOZOO(5,k)
      enddo
      close(3)
...
!     open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS_092020/ION_sil.dat')
      ...
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/OXY_2021/ION_oxy.dat')
      ...
      close(3)
!      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/Bact_Lev_inv.txt')
      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/Bact_Lev2_inv.txt')
      read(3,*)nmaxprofk(6,7)
      do k=1,nmaxprofk(6,7)
      read(3,*)Init_PRF_bact(6,k),InitVal_bact(6,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DOC_boum_inv.txt')
      read(3,*)nmaxprofk(6,8)
      do k=1,nmaxprofk(6,8)
      read(3,*)Init_PRF_doc(6,k),x1,x2,InitVal_DOC(6,k)
      InitVal_DOC(6,k)=max(InitVal_DOC(6,k)-Init_DOC_Refr,0.)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DON_boum_inv.txt')
      read(3,*)nmaxprofk(6,9)
      do k=1,nmaxprofk(6,9)
      read(3,*)Init_PRF_don(6,k),x1,x2,InitVal_DON(6,k)
      InitVal_DON(6,k)=max(InitVal_DON(6,k)-Init_DON_Refr,0.)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DOP_boum_inv.txt')
      read(3,*)nmaxprofk(6,10)
      do k=1,nmaxprofk(6,10)
      read(3,*)Init_PRF_dop(6,k),x1,x2,InitVal_DOP(6,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS_022021/ION_chl.dat')
      read(3,*)nmaxprofk(6,11)
      do k=1,nmaxprofk(6,11)
      read(3,*)Init_PRF_CHL(6,k),InitVal_CHL(6,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PHYTO_POURCENT022021/ION_micro.dat')
      read(3,*)nmaxprofk(6,12)
      do k=1,nmaxprofk(6,12)
      read(3,*)Init_PRF_MICRO(6,k),InitVal_MICRO(6,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PHYTO_POURCENT022021/ION_nano.dat')
      read(3,*)nmaxprofk(6,13)
      do k=1,nmaxprofk(6,13)
      read(3,*)Init_PRF_MICRO(6,k),InitVal_NANO(6,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PHYTO_POURCENT022021/ION_pico.dat')
      read(3,*)nmaxprofk(6,14)
      do k=1,nmaxprofk(6,14)
      read(3,*)Init_PRF_MICRO(6,k),InitVal_PICO(6,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/POM_ION_inv.txt')
      read(3,*)nmaxprofk(6,15)
      do k=1,nmaxprofk(6,15)
      read(3,*)Init_PRF_POM(6,k),InitVal_POC(6,k),InitVal_PON(6,k),InitVal_POP(6,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/ZOO_20/E_nano.dat')
      read(3,*)nmaxprofk(6,16)
      do k=1,nmaxprofk(6,16)
      read(3,*)Init_PRF_NANOZOO(6,k),InitVal_NANOZOO(6,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/ZOO_20/E_micro.dat')
      read(3,*)nmaxprofk(6,17)
      do k=1,nmaxprofk(6,17)
      read(3,*)Init_PRF_NANOZOO(6,k),InitVal_MICROZOO(6,k)
      enddo
      close(3)  
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/ZOO_20/ION_meso.dat')
      read(3,*)nmaxprofk(6,18)
      do k=1,nmaxprofk(6,18)
      read(3,*)Init_PRF_MESO(6,k),InitVal_MESOZOO(6,k)
      enddo
      close(3)
! ADR
...
!     open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS_092020/ADRIA_sil.dat')
      ...
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/OXY_2021/ADRIA_oxy.dat')
...
!     open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/Bact_Lev_inv.txt')
      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/Bact_Lev2_inv.txt')
      read(3,*)nmaxprofk(7,7)
      do k=1,nmaxprofk(7,7)
      read(3,*)Init_PRF_bact(7,k),InitVal_bact(7,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DOC_boum_inv.txt')
      read(3,*)nmaxprofk(7,8)
      do k=1,nmaxprofk(7,8)
      read(3,*)Init_PRF_doc(7,k),x1,x2,InitVal_DOC(7,k)
      InitVal_DOC(7,k)=max(InitVal_DOC(7,k)-Init_DOC_Refr,0.)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DON_boum_inv.txt')
      read(3,*)nmaxprofk(7,9)
      do k=1,nmaxprofk(7,9)
      read(3,*)Init_PRF_don(7,k),x1,x2,InitVal_DON(7,k)
      InitVal_DON(7,k)=max(InitVal_DON(7,k)-Init_DON_Refr,0.)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DOP_boum_inv.txt')
      read(3,*)nmaxprofk(7,10)
      do k=1,nmaxprofk(7,10)
      read(3,*)Init_PRF_dop(7,k),x1,x2,InitVal_DOP(7,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS_022021/ADRIA_chl.dat')
      read(3,*)nmaxprofk(7,11)
      do k=1,nmaxprofk(7,11)
      read(3,*)Init_PRF_CHL(7,k),InitVal_CHL(7,k)
      enddo
      close(3)
!      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PHYTO_POURCENT022021/ION_micro.dat')
!      read(3,*)nmaxprofk(7,12)
!      do k=1,nmaxprofk(7,12)
!      read(3,*)Init_PRF_MICRO(7,k),InitVal_MICRO(7,k)
!      enddo
!      close(3)
!      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PHYTO_POURCENT022021/ION_nano.dat')
!      read(3,*)nmaxprofk(7,13)
!      do k=1,nmaxprofk(7,13)
!      read(3,*)Init_PRF_MICRO(7,k),InitVal_NANO(7,k)
!      enddo
!      close(3)
!      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PHYTO_POURCENT022021/ION_pico.dat')
!      read(3,*)nmaxprofk(7,14)
!      do k=1,nmaxprofk(7,14)
!      read(3,*)Init_PRF_MICRO(7,k),InitVal_PICO(7,k)
!      enddo
!      close(3)
      nmaxprofk(7,12)=nmaxprofk(6,12)
      nmaxprofk(7,13)=nmaxprofk(6,13)
      nmaxprofk(7,14)=nmaxprofk(6,14)
      do k=1,nmaxprofk(7,12)
      Init_PRF_MICRO(7,k)=Init_PRF_MICRO(6,k)
      InitVal_MICRO(7,k)=InitVal_MICRO(6,k)
      enddo
      do k=1,nmaxprofk(7,13)
      InitVal_NANO(7,k)=InitVal_NANO(6,k)
      enddo
      do k=1,nmaxprofk(7,14)
      InitVal_PICO(7,k)=InitVal_PICO(6,k)
      enddo

      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/POM_ION_inv.txt')
      read(3,*)nmaxprofk(7,15)
      do k=1,nmaxprofk(7,15)
      read(3,*)Init_PRF_POM(7,k),InitVal_POC(7,k),InitVal_PON(7,k),InitVal_POP(7,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/ZOO_20/E_nano.dat')
      read(3,*)nmaxprofk(7,16)
      do k=1,nmaxprofk(7,16)
      read(3,*)Init_PRF_NANOZOO(7,k),InitVal_NANOZOO(7,k)
      enddo
      close(3)   
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/ZOO_20/E_micro.dat')
      read(3,*)nmaxprofk(7,17)
      do k=1,nmaxprofk(7,17)
      read(3,*)Init_PRF_NANOZOO(7,k),InitVal_MICROZOO(7,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/ZOO_20/ION_meso.dat')
      read(3,*)nmaxprofk(7,18)
      do k=1,nmaxprofk(7,18)
      read(3,*)Init_PRF_MESO(7,k),InitVal_MESOZOO(7,k)
      enddo
      close(3)   
...
!     open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS_092020/EGEE_sil.dat')
      ...
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/OXY_2021/EGEE_oxy.dat')
...
!      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/Bact_Lev_inv.txt')
      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/Bact_Lev2_inv.txt')
      read(3,*)nmaxprofk(8,7)
      do k=1,nmaxprofk(8,7)
      read(3,*)Init_PRF_bact(8,k),InitVal_bact(8,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DOC_boum_inv.txt')
      read(3,*)nmaxprofk(8,8)
      do k=1,nmaxprofk(8,8)
      read(3,*)Init_PRF_doc(8,k),x1,x2,x3,InitVal_DOC(8,k)
      InitVal_DOC(8,k)=max(InitVal_DOC(8,k)-Init_DOC_Refr,0.)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DON_boum_inv.txt')
      read(3,*)nmaxprofk(8,9)
      do k=1,nmaxprofk(8,9)
      read(3,*)Init_PRF_don(8,k),x1,x2,x3,InitVal_DON(8,k)
      InitVal_DON(8,k)=max(InitVal_DON(8,k)-Init_DON_Refr,0.)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DOP_boum_inv.txt')
      read(3,*)nmaxprofk(8,10)
      do k=1,nmaxprofk(8,10)
      read(3,*)Init_PRF_dop(8,k),x1,x2,x3,InitVal_DOP(8,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS_022021/EGEE_chl.dat')
      read(3,*)nmaxprofk(8,11)
      do k=1,nmaxprofk(8,11)
      read(3,*)Init_PRF_CHL(8,k),InitVal_CHL(8,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PHYTO_POURCENT022021/LEV_micro.dat')
      read(3,*)nmaxprofk(8,12)
      do k=1,nmaxprofk(8,12)
      read(3,*)Init_PRF_MICRO(8,k),InitVal_MICRO(8,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PHYTO_POURCENT022021/LEV_nano.dat')
      read(3,*)nmaxprofk(8,13)
      do k=1,nmaxprofk(8,13)
      read(3,*)Init_PRF_MICRO(8,k),InitVal_NANO(8,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PHYTO_POURCENT022021/LEV_pico.dat')
      read(3,*)nmaxprofk(8,14)
      do k=1,nmaxprofk(8,14)
      read(3,*)Init_PRF_MICRO(8,k),InitVal_PICO(8,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/POM_LEV_inv.txt')
      read(3,*)nmaxprofk(8,15)
      do k=1,nmaxprofk(8,15)
      read(3,*)Init_PRF_POM(8,k),InitVal_POC(8,k),InitVal_PON(8,k),InitVal_POP(8,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/ZOO_20/E_nano.dat')
      read(3,*)nmaxprofk(8,16)
      do k=1,nmaxprofk(8,16)
      read(3,*)Init_PRF_NANOZOO(8,k),InitVal_NANOZOO(8,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/ZOO_20/E_micro.dat')
      read(3,*)nmaxprofk(8,17)
      do k=1,nmaxprofk(8,17)
      read(3,*)Init_PRF_NANOZOO(8,k),InitVal_MICROZOO(8,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/ZOO_20/LEV_meso.dat')
      read(3,*)nmaxprofk(8,18)
      do k=1,nmaxprofk(8,18)
      read(3,*)Init_PRF_MESO(8,k),InitVal_MESOZOO(8,k)
      enddo
      close(3)
...
!     open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS_092020/LEV_sil.dat')
      ...
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/OXY_2021/LEV_oxy.dat')
...
!      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/Bact_Lev_inv.txt')
      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/Bact_Lev2_inv.txt')
      read(3,*)nmaxprofk(9,7)
      do k=1,nmaxprofk(9,7)
      read(3,*)Init_PRF_bact(9,k),InitVal_bact(9,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DOC_boum_inv.txt')
      read(3,*)nmaxprofk(9,8)
      do k=1,nmaxprofk(9,8)
      read(3,*)Init_PRF_doc(9,k),x1,x2,x3,InitVal_DOC(9,k)
      InitVal_DOC(9,k)=max(InitVal_DOC(9,k)-Init_DOC_Refr,0.)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DON_boum_inv.txt')
      read(3,*)nmaxprofk(9,9)
      do k=1,nmaxprofk(9,9)
      read(3,*)Init_PRF_don(9,k),x1,x2,x3,InitVal_DON(9,k)
      InitVal_DON(9,k)=max(InitVal_DON(9,k)-Init_DON_Refr,0.)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DOP_boum_inv.txt')
      read(3,*)nmaxprofk(9,10)
      do k=1,nmaxprofk(9,10)
      read(3,*)Init_PRF_dop(9,k),x1,x2,x3,InitVal_DOP(9,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS_022021/LEV_chl.dat')
      read(3,*)nmaxprofk(9,11)
      do k=1,nmaxprofk(9,11)
      read(3,*)Init_PRF_CHL(9,k),InitVal_CHL(9,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PHYTO_POURCENT022021/LEV_micro.dat')
      read(3,*)nmaxprofk(9,12)
      do k=1,nmaxprofk(9,12)
      read(3,*)Init_PRF_MICRO(9,k),InitVal_MICRO(9,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PHYTO_POURCENT022021/LEV_nano.dat')
      read(3,*)nmaxprofk(9,13)
      do k=1,nmaxprofk(9,13)
      read(3,*)Init_PRF_MICRO(9,k),InitVal_NANO(9,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PHYTO_POURCENT022021/LEV_pico.dat')
      read(3,*)nmaxprofk(9,14)
      do k=1,nmaxprofk(9,14)
      read(3,*)Init_PRF_MICRO(9,k),InitVal_PICO(9,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/POM_LEV_inv.txt')
      read(3,*)nmaxprofk(9,15)
      do k=1,nmaxprofk(9,15)
      read(3,*)Init_PRF_POM(9,k),InitVal_POC(9,k),InitVal_PON(9,k),InitVal_POP(9,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/ZOO_20/E_nano.dat')
      read(3,*)nmaxprofk(9,16)
      do k=1,nmaxprofk(9,16)
      read(3,*)Init_PRF_NANOZOO(9,k),InitVal_NANOZOO(9,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/ZOO_20/E_micro.dat')
      read(3,*)nmaxprofk(9,17)
      do k=1,nmaxprofk(9,17)
      read(3,*)Init_PRF_NANOZOO(9,k),InitVal_MICROZOO(9,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/ZOO_20/LEV_meso.dat')
      read(3,*)nmaxprofk(9,18)
      do k=1,nmaxprofk(9,18)
      read(3,*)Init_PRF_MESO(9,k),InitVal_MESOZOO(9,k)
      enddo
      close(3)
...
!      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/mean_bact_inv.txt')
       open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/mean_bact2_inv.txt')
      read(3,*)nmaxprofk(10,7)
      do k=1,nmaxprofk(10,7)
      read(3,*)Init_PRF_bact(10,k),InitVal_bact(10,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DOC_boum_inv.txt')
      read(3,*)nmaxprofk(10,8)
      do k=1,nmaxprofk(10,8)
      read(3,*)Init_PRF_doc(10,k),InitVal_DOC(10,k)
      InitVal_DOC(10,k)=max(InitVal_DOC(10,k)-Init_DOC_Refr,0.)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DON_boum_inv.txt')
      read(3,*)nmaxprofk(10,9)
      do k=1,nmaxprofk(10,9)
      read(3,*)Init_PRF_don(10,k),InitVal_DON(10,k)
      InitVal_DON(10,k)=max(InitVal_DON(10,k)-Init_DON_Refr,0.)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/SIMED/PROFILDOM/DOP_boum_inv.txt')
      read(3,*)nmaxprofk(10,10)
      do k=1,nmaxprofk(10,10)
      read(3,*)Init_PRF_dop(10,k),InitVal_DOP(10,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PROFILNUTS_022021/LIG_chl.dat')
      read(3,*)nmaxprofk(10,11)
      do k=1,nmaxprofk(10,11)
      read(3,*)Init_PRF_CHL(10,k),InitVal_CHL(10,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PHYTO_POURCENT022021/LIG_micro.dat')
      read(3,*)nmaxprofk(10,12)
      do k=1,nmaxprofk(10,12)
      read(3,*)Init_PRF_MICRO(10,k),InitVal_MICRO(10,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PHYTO_POURCENT022021/LIG_nano.dat')
      read(3,*)nmaxprofk(10,13)
      do k=1,nmaxprofk(10,13)
      read(3,*)Init_PRF_MICRO(10,k),InitVal_NANO(10,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/PHYTO_POURCENT022021/LIG_pico.dat')
      read(3,*)nmaxprofk(10,14)
      do k=1,nmaxprofk(10,14)
      read(3,*)Init_PRF_MICRO(10,k),InitVal_PICO(10,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/initdyfamed/POMDyfamed_072004_inv.txt')
      read(3,*)nmaxprofk(10,15)
      do k=1,nmaxprofk(10,15)
      read(3,*)Init_PRF_POM(10,k),InitVal_POC(10,k),InitVal_PON(10,k),InitVal_POP(10,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/ZOO_20/W_nano.dat')
      read(3,*)nmaxprofk(10,16)
      do k=1,nmaxprofk(10,16)
      read(3,*)Init_PRF_NANOZOO(10,k),InitVal_NANOZOO(10,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/ZOO_20/W_micro.dat')
      read(3,*)nmaxprofk(10,17)
      do k=1,nmaxprofk(10,17)
      read(3,*)Init_PRF_NANOZOO(10,k),InitVal_MICROZOO(10,k)
      enddo
      close(3)
      open(unit=3,file='/tmpdir/jhabib/simulations/joelle_profil/ZOO_20/NW_meso.dat')
      read(3,*)nmaxprofk(10,18)
      do k=1,nmaxprofk(10,18)
      read(3,*)Init_PRF_MESO(10,k),InitVal_MESOZOO(10,k)
      enddo
      close(3)
...
!!!!!!!!!!!!!!!!!!!! END PROFILE LOADING !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      do i=1,imax !mbio1,mbio2
      do j=1,jmax !nbio1,nbio2
...
! Pour la chlorophylle 
         if (depth_t(i,j,k)<=Init_PRF_CHL(polygon_m(i,j),1)) then
           bio_t(i,j,k,iDiaChl)        = InitVal_CHL(polygon_m(i,j),1)
         elseif(depth_t(i,j,k)>=Init_PRF_CHL(polygon_m(i,j),nmaxprofk(polygon_m(i,j),11)))then
           bio_t(i,j,k,iDiaChl)    =InitVal_CHL(polygon_m(i,j),nmaxprofk(polygon_m(i,j),11))
         else

           K_pr=1
           do while(depth_t(i,j,k)>Init_PRF_CHL(polygon_m(i,j),K_pr))
             K_pr=K_pr+1
           enddo

           r1=-Init_PRF_CHL(polygon_m(i,j),K_pr-1)+depth_t(i,j,k)
           r2=-depth_t(i,j,k)+Init_PRF_CHL(polygon_m(i,j),K_pr)
           deltap=Init_PRF_CHL(polygon_m(i,j),K_pr)-Init_PRF_CHL(polygon_m(i,j),K_pr-1)

           bio_t(i,j,k,iDiaChl)  =(r1*InitVal_CHL(polygon_m(i,j),K_pr  ) &
                                   +r2*InitVal_CHL(polygon_m(i,j),K_pr-1))/deltap

          endif


!Pour le zoo MICRO et NANO

         if (depth_t(i,j,k)<=Init_PRF_NANOZOO(polygon_m(i,j),1)) then
           bio_t(i,j,k,iZooNanoC)        = InitVal_NANOZOO(polygon_m(i,j),1)
           bio_t(i,j,k,iZooMicroC)       = InitVal_MICROZOO(polygon_m(i,j),1)
         elseif(depth_t(i,j,k)>=Init_PRF_NANOZOO(polygon_m(i,j),nmaxprofk(polygon_m(i,j),17))) then
           bio_t(i,j,k,iZooNanoC)      =InitVal_NANOZOO(polygon_m(i,j),nmaxprofk(polygon_m(i,j),17))
           bio_t(i,j,k,iZooMicroC)        =InitVal_MICROZOO(polygon_m(i,j),nmaxprofk(polygon_m(i,j),17))
         else

           K_pr=1
           do while(depth_t(i,j,k)>Init_PRF_NANOZOO(polygon_m(i,j),K_pr))
             K_pr=K_pr+1
           enddo
        
          r1=-Init_PRF_NANOZOO(polygon_m(i,j),K_pr-1)+depth_t(i,j,k)
          r2=-depth_t(i,j,k)+Init_PRF_NANOZOO(polygon_m(i,j),K_pr)

          deltap=Init_PRF_NANOZOO(polygon_m(i,j),K_pr)-Init_PRF_NANOZOO(polygon_m(i,j),K_pr-1)
          
           bio_t(i,j,k,iZooNanoC)  =(r1*InitVal_NANOZOO(polygon_m(i,j),K_pr  ) &
                                   +r2*InitVal_NANOZOO(polygon_m(i,j),K_pr-1))/deltap

           bio_t(i,j,k,iZooMicroC)  =(r1*InitVal_MICROZOO(polygon_m(i,j),K_pr  ) &
                                   +r2*InitVal_MICROZOO(polygon_m(i,j),K_pr-1))/deltap

          endif
!pour le zoo meso 
         
        if (depth_t(i,j,k)<=Init_PRF_MESO(polygon_m(i,j),1)) then
           bio_t(i,j,k,iZooMesoC)        = InitVal_MESOZOO(polygon_m(i,j),1)
           
         elseif(depth_t(i,j,k)>=Init_PRF_MESO(polygon_m(i,j),nmaxprofk(polygon_m(i,j),18)))then
           bio_t(i,j,k,iZooMesoC)        =InitVal_MESOZOO(polygon_m(i,j),nmaxprofk(polygon_m(i,j),18))
          else

           K_pr=1
           do while(depth_t(i,j,k)>Init_PRF_MESO(polygon_m(i,j),K_pr))
             K_pr=K_pr+1
           enddo

          r1=-Init_PRF_MESO(polygon_m(i,j),K_pr-1)+depth_t(i,j,k)
          r2=-depth_t(i,j,k)+Init_PRF_MESO(polygon_m(i,j),K_pr)

          deltap=Init_PRF_MESO(polygon_m(i,j),K_pr)-Init_PRF_MESO(polygon_m(i,j),K_pr-1)

           bio_t(i,j,k,iZooMesoC)  =(r1*InitVal_MESOZOO(polygon_m(i,j),K_pr  ) &
                                   +r2*InitVal_MESOZOO(polygon_m(i,j),K_pr-1))/deltap

          endif


! Pour le phytoplancton/MICRO 
         if (depth_t(i,j,k)<=Init_PRF_MICRO(polygon_m(i,j),1)) then
           perchl(i,j,k,3)        = InitVal_MICRO(polygon_m(i,j),1)
           perchl(i,j,k,1)        = InitVal_PICO(polygon_m(i,j),1)
           perchl(i,j,k,2)        = InitVal_NANO(polygon_m(i,j),1)

         elseif(depth_t(i,j,k)>=Init_PRF_MICRO(polygon_m(i,j),nmaxprofk(polygon_m(i,j),12)))then
           perchl(i,j,k,3)=InitVal_MICRO(polygon_m(i,j),nmaxprofk(polygon_m(i,j),12))
           perchl(i,j,k,1)=InitVal_PICO(polygon_m(i,j),nmaxprofk(polygon_m(i,j),12))
           perchl(i,j,k,2)=InitVal_NANO(polygon_m(i,j),nmaxprofk(polygon_m(i,j),12))
         else

           K_pr=1
           do while(depth_t(i,j,k)>Init_PRF_MICRO(polygon_m(i,j),K_pr))
             K_pr=K_pr+1
           enddo

!           print*,'prf_micro',polygon_m(i,j),K_pr,depth_t(i,j,k),nmaxprofk(8,12),nmaxprofk(8,13),nmaxprofk(8,14)
!           print*,'prf_micro2',Init_PRF_MICRO(polygon_m(i,j),K_pr-1),Init_PRF_MICRO(polygon_m(i,j),K_pr)
           r1=-Init_PRF_MICRO(polygon_m(i,j),K_pr-1)+depth_t(i,j,k)
!           print*,'prf_micro3',r1
           r2=-depth_t(i,j,k)+Init_PRF_MICRO(polygon_m(i,j),K_pr)
!           print*,'prf_micro4',r2
           deltap=Init_PRF_MICRO(polygon_m(i,j),K_pr)-Init_PRF_MICRO(polygon_m(i,j),K_pr-1)
!           print*,'prf_micro5',deltap
!
          if(deltap>0) then
          perchl(i,j,k,3)  =(r1*InitVal_MICRO(polygon_m(i,j),K_pr  ) &
                            +r2*InitVal_MICRO(polygon_m(i,j),K_pr-1))/deltap


           perchl(i,j,k,1)  =(r1*InitVal_PICO(polygon_m(i,j),K_pr  ) &
                             +r2*InitVal_PICO(polygon_m(i,j),K_pr-1))/deltap

          perchl(i,j,k,2)  =(r1*InitVal_NANO(polygon_m(i,j),K_pr  ) &
                            +r2*InitVal_NANO(polygon_m(i,j),K_pr-1))/deltap
          endif 
...
! Pour les bactéries
         if (depth_t(i,j,k)<=Init_PRF_bact(polygon_m(i,j),1)) then
           bio_t(i,j,k,ibactc)        = InitVal_bact(polygon_m(i,j),1)
         elseif(depth_t(i,j,k)>=Init_PRF_bact(polygon_m(i,j),nmaxprofk(polygon_m(i,j),7)))then
           bio_t(i,j,k,ibactc)    = InitVal_bact(polygon_m(i,j),nmaxprofk(polygon_m(i,j),7))
         else

           K_pr=1
           do while(depth_t(i,j,k)>Init_PRF_bact(polygon_m(i,j),K_pr))
             K_pr=K_pr+1
           enddo

           r1=-Init_PRF_bact(polygon_m(i,j),K_pr-1)+depth_t(i,j,k)
           r2=-depth_t(i,j,k)+Init_PRF_bact(polygon_m(i,j),K_pr)
           deltap=Init_PRF_bact(polygon_m(i,j),K_pr)-Init_PRF_bact(polygon_m(i,j),K_pr-1)

           bio_t(i,j,k,ibactc)  =(r1*InitVal_bact(polygon_m(i,j),K_pr  ) &
                                   +r2*InitVal_bact(polygon_m(i,j),K_pr-1))/deltap

          endif

! Pour le DOC
         if (depth_t(i,j,k)<=Init_PRF_DOC(polygon_m(i,j),1)) then
           bio_t(i,j,k,imOdC)        = InitVal_DOC(polygon_m(i,j),1)
         elseif(depth_t(i,j,k)>=Init_PRF_DOC(polygon_m(i,j),nmaxprofk(polygon_m(i,j),8)))then
           bio_t(i,j,k,imOdC)    = InitVal_DOC(polygon_m(i,j),nmaxprofk(polygon_m(i,j),8))
         else

           K_pr=1
           do while(depth_t(i,j,k)>Init_PRF_DOC(polygon_m(i,j),K_pr))
             K_pr=K_pr+1
           enddo

           r1=-Init_PRF_DOC(polygon_m(i,j),K_pr-1)+depth_t(i,j,k)
           r2=-depth_t(i,j,k)+Init_PRF_DOC(polygon_m(i,j),K_pr)
           deltap=Init_PRF_DOC(polygon_m(i,j),K_pr)-Init_PRF_DOC(polygon_m(i,j),K_pr-1)

           bio_t(i,j,k,imOdC)  =(r1*InitVal_DOC(polygon_m(i,j),K_pr  ) &
                                   +r2*InitVal_DOC(polygon_m(i,j),K_pr-1))/deltap

          endif

! Pour le DON
         if (depth_t(i,j,k)<=Init_PRF_DON(polygon_m(i,j),1)) then
           bio_t(i,j,k,imOdN)        = InitVal_DON(polygon_m(i,j),1)
         elseif(depth_t(i,j,k)>=Init_PRF_DON(polygon_m(i,j),nmaxprofk(polygon_m(i,j),9)))then
           bio_t(i,j,k,imOdN)    = InitVal_DON(polygon_m(i,j),nmaxprofk(polygon_m(i,j),9))
         else

           K_pr=1
           do while(depth_t(i,j,k)>Init_PRF_DON(polygon_m(i,j),K_pr))
             K_pr=K_pr+1
           enddo

           r1=-Init_PRF_DON(polygon_m(i,j),K_pr-1)+depth_t(i,j,k)
           r2=-depth_t(i,j,k)+Init_PRF_DON(polygon_m(i,j),K_pr)
           deltap=Init_PRF_DON(polygon_m(i,j),K_pr)-Init_PRF_DON(polygon_m(i,j),K_pr-1)

           bio_t(i,j,k,imOdN)  =(r1*InitVal_DON(polygon_m(i,j),K_pr  ) &
                                   +r2*InitVal_DON(polygon_m(i,j),K_pr-1))/deltap

          endif

! Pour le DOP
         if (depth_t(i,j,k)<=Init_PRF_DOP(polygon_m(i,j),1)) then
           bio_t(i,j,k,imOdP)        = InitVal_DOP(polygon_m(i,j),1)
         elseif(depth_t(i,j,k)>=Init_PRF_DOP(polygon_m(i,j),nmaxprofk(polygon_m(i,j),10)))then
           bio_t(i,j,k,imOdP)    = InitVal_DOP(polygon_m(i,j),nmaxprofk(polygon_m(i,j),10))
         else

           K_pr=1
           do while(depth_t(i,j,k)>Init_PRF_DOP(polygon_m(i,j),K_pr))
             K_pr=K_pr+1
           enddo

           r1=-Init_PRF_DOP(polygon_m(i,j),K_pr-1)+depth_t(i,j,k)
           r2=-depth_t(i,j,k)+Init_PRF_DOP(polygon_m(i,j),K_pr)
           deltap=Init_PRF_DOP(polygon_m(i,j),K_pr)-Init_PRF_DOP(polygon_m(i,j),K_pr-1)

           bio_t(i,j,k,imOdP)  =(r1*InitVal_DOP(polygon_m(i,j),K_pr  ) &
                                   +r2*InitVal_DOP(polygon_m(i,j),K_pr-1))/deltap
...
! Pour le POM
         if (depth_t(i,j,k)<=Init_PRF_POM(polygon_m(i,j),1)) then
           bio_t(i,j,k,ismopc)        = InitVal_POC(polygon_m(i,j),1)
           bio_t(i,j,k,ismopn)        = InitVal_PON(polygon_m(i,j),1)
           bio_t(i,j,k,ismopp)        = InitVal_POP(polygon_m(i,j),1)
         elseif(depth_t(i,j,k)>=Init_PRF_POM(polygon_m(i,j),nmaxprofk(polygon_m(i,j),15)))then
           bio_t(i,j,k,ismopc)    = InitVal_POC(polygon_m(i,j),nmaxprofk(polygon_m(i,j),15))
           bio_t(i,j,k,ismopn)    = InitVal_PON(polygon_m(i,j),nmaxprofk(polygon_m(i,j),15))
           bio_t(i,j,k,ismopp)    = InitVal_POP(polygon_m(i,j),nmaxprofk(polygon_m(i,j),15))

         else

           K_pr=1
           do while(depth_t(i,j,k)>Init_PRF_POM(polygon_m(i,j),K_pr))
             K_pr=K_pr+1
           enddo

           r1=-Init_PRF_POM(polygon_m(i,j),K_pr-1)+depth_t(i,j,k)
           r2=-depth_t(i,j,k)+Init_PRF_POM(polygon_m(i,j),K_pr)
           deltap=Init_PRF_POM(polygon_m(i,j),K_pr)-Init_PRF_POM(polygon_m(i,j),K_pr-1)

           bio_t(i,j,k,ismopc)  =(r1*InitVal_POC(polygon_m(i,j),K_pr  ) &
                                   +r2*InitVal_POC(polygon_m(i,j),K_pr-1))/deltap

           bio_t(i,j,k,ismopn)  =(r1*InitVal_PON(polygon_m(i,j),K_pr  ) &
                                   +r2*InitVal_PON(polygon_m(i,j),K_pr-1))/deltap

           bio_t(i,j,k,ismopp)  =(r1*InitVal_POP(polygon_m(i,j),K_pr  ) &
                                   +r2*InitVal_POP(polygon_m(i,j),K_pr-1))/deltap

          endif


          bio_t(i,j,k,iSyneChl)=perchl(i,j,k,1)*bio_t(i,j,k,iDiaChl)/100
          bio_t(i,j,k,iNanoChl)=perchl(i,j,k,2)*bio_t(i,j,k,iDiaChl)/100
          bio_t(i,j,k,iDiaChl) =perchl(i,j,k,3)*bio_t(i,j,k,iDiaChl)/100
...
!!! Repartition in small and large particules
      if(depth_t(i,j,k)>-300.) then
!      bio_t(i,j,k,iLMOPC) = (1 - PropMOP) * bio_t(i,j,k,iSMOPC)
!      bio_t(i,j,k,iSMOPC) =      PropMOP  * bio_t(i,j,k,iSMOPC)
      bio_t(i,j,k,iLMOPC) = 0.
      bio_t(i,j,k,iSMOPC) = bio_t(i,j,k,iSMOPC)
      bio_t(i,j,k,iLMOPN) = 0.
      bio_t(i,j,k,iSMOPN) = bio_t(i,j,k,iSMOPN)
      else
      bio_t(i,j,k,iLMOPC) = 0.8 * bio_t(i,j,k,iSMOPC)
      bio_t(i,j,k,iSMOPC) = 0.2 * bio_t(i,j,k,iSMOPC)
      bio_t(i,j,k,iLMOPN) = 0.8 * bio_t(i,j,k,iSMOPN)
      bio_t(i,j,k,iSMOPN) = 0.2 * bio_t(i,j,k,iSMOPN)
      endif
