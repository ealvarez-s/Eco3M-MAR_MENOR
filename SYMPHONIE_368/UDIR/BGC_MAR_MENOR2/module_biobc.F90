...
!..........................................................
      ...
      if(biobc_init_flag==1)biobclistline=0 ! initialisation
       if(par%rank==0) &
          write(*,*)trim(directory)//txtslash//'biovarfilelist'
...
!       read(3,'(a)')texte250    ! (rapidement) le debut du fichier
  ...
  319   read(3,'(a)')texte250
        ...
        !k=index(texte250,'.nc ')
        k=index(texte250,'.ECO3M-S.LA.tlse_xtrW.nc ')
...
!     do vb =1,vbmax
       ...
       if(status/=0) then
        print*,'biovarname(vb)',trim(biovarname(vb))
        stop 'erreur nf_inq_varid biobc_interp_step1'
       endif
