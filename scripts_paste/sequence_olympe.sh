...
INDIR3=/tmpdir/alvarez/MAR_MENOR/BGC_MAR_MENOR/GRAPHIQUES/RUN_reference_10days_output
OUTDIR=/tmpdir/alvarez/MAR_MENOR/BGC_MAR_MENOR/GRAPHIQUES/RUN_reference_10days_output
CODEDIR=/tmpdir/alvarez/MAR_MENOR/scripts_paste
