...
INDIR3=/home/alvarez/EVA/Eco3M-MAR_MENOR/BGC_MAR_MENOR/GRAPHIQUES/RUN_test_T37_lessP_LR
OUTDIR=/home/alvarez/EVA/Eco3M-MAR_MENOR/BGC_MAR_MENOR/GRAPHIQUES/RUN_test_T37_lessP_LR
...
#Rscript ${CODEDIR}/paste_supp_variables_2D.R ${INDIR3} Siefflux2d ${OUTDIER}
...
Rscript ${CODEDIR}/paste_supp_variables_3D.R ${INDIR3} gpp3d ${OUTDIR}
#Rscript ${CODEDIR}/paste_supp_variables_3D.R ${INDIR3} resp3d ${OUTDIR}
#Rscript ${CODEDIR}/paste_supp_variables_3D.R ${INDIR3} exuc3d ${OUTDIR}
#Rscript ${CODEDIR}/paste_supp_variables_3D.R ${INDIR3} nitrif3d ${OUTDIR}
#Rscript ${CODEDIR}/paste_supp_variables_3D.R ${INDIR3} uptnit3d ${OUTDIR}
#Rscript ${CODEDIR}/paste_supp_variables_3D.R ${INDIR3} O2Flux ${OUTDIR}
#Rscript ${CODEDIR}/paste_supp_variables_3D.R ${INDIR3} CO2_Flux ${OUTDIR}
...
Rscript ${CODEDIR}/paste_state_variables_3D.R ${INDIR3} pH ${OUTDIR}
Rscript ${CODEDIR}/paste_state_variables_3D.R ${INDIR3} PAR ${OUTDIR}
