...
INDIR3=/home/alvarez/EVA/Eco3M-MAR_MENOR/BGC_MAR_MENOR/GRAPHIQUES/RUN_longSimul_T37_bentos37_pdeNit
OUTDIR=/home/alvarez/EVA/Eco3M-MAR_MENOR/BGC_MAR_MENOR/GRAPHIQUES/RUN_longSimul_T37_bentos37_pdeNit
...
Rscript ${CODEDIR}/paste_supp_variables_2D.R ${INDIR3} TAefflux2d ${OUTDIR}
...
Rscript ${CODEDIR}/paste_supp_variables_2D.R ${INDIR3} CBDetB ${OUTDIR}
...
#Rscript ${CODEDIR}/paste_supp_variables_2D.R ${INDIR3} pCO2w ${OUTDIR}    # instantaneous
#Rscript ${CODEDIR}/paste_supp_variables_2D.R ${INDIR3} pCO2a ${OUTDIR}
