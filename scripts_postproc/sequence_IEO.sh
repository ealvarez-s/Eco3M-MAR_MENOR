...
INDIR3=/tmpdir/alvarez/EVA/Eco3M-MAR_MENOR/BGC_MAR_MENOR/GRAPHIQUES/RUN_reference_10days
OUTDIR=/tmpdir/alvarez/EVA/Eco3M-MAR_MENOR/BGC_MAR_MENOR/GRAPHIQUES/RUN_reference_10days
CODEDIR=/tmpdir/alvarez/EVA/Eco3M-MAR_MENOR/scripts_postproc

Rscript ${CODEDIR}/paste_forcing_variables_2D.R ${INDIR3} ssr ${OUTDIR}
